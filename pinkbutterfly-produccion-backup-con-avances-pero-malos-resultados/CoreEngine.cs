        ...
        private void UpdateProximityScores(int tfMinutes)
        {
            ...
            try
            {
                ...
                foreach (var structure in structures)
                {
                    ...
                    {
                        // Alinear proximidad operativa con ScoringEngine: usar el borde MÁS CERCANO al precio actual
                    ...
                    if (structure is FVGInfo && distanceATR >= _config.ProxMaxATRFactor)
                    {
                        proximityFactor = 0.0;
                    }
