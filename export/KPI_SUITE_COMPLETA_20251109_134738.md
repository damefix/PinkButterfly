...
**Fecha:** 2025-11-09 13:48:04  
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251109_134738.csv`  
**Trades Analizados:** 1
...
|------------|----------------------|-------------|
| **CoreScore** | 0.2500 | 28.2% |
| **Proximity** | 0.3966 | 44.8% |
| **Confluence** | 0.1500 | 16.9% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.0890 | 10.0% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.8856 | 100% |
