...
**Fecha:** 2025-11-06 09:03:42
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251106_085040.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251106_085040.csv`
...
public int MaxTPDistancePoints { get; set; } = 81; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 78.5pts, TP: 82.0pts)
...
**Estado actual:** R:R promedio = 50.42
**Gap:** -48.67 (necesitas mejorar R:R)
...
2. **MaxTPDistancePoints:** 120 → **81** (P90 real)
...
**Problema:** R:R actual (50.42) < R:R mínimo (1.75)
