...
|------|---------------|---------------|------------|
| StructureFusion | 24640 | 100.0% | 100.0% |
| ProximityAnalyzer | 3254 | 13.2% | 13.2% |
| DFM_Evaluated | 610 | 18.7% | 2.5% |
| DFM_Passed | 610 | 100.0% | 2.5% |
| RiskCalculator | 5980 | 980.3% | 24.3% |
| Risk_Accepted | 34 | 0.6% | 0.1% |
| TradeManager | 11 | 32.4% | 0.0% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 5946 señales, -99.4%)
- **Tasa de conversión final:** 0.04% (de 24640 zonas iniciales → 11 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,530 | 51.6% |
| ENTRY_TOO_FAR | 756 | 25.5% |
| TP_CHECK_FAIL | 393 | 13.2% |
| NO_SL | 288 | 9.7% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,530 rechazos, 51.6%)
