...
**Fecha:** 2025-11-10 12:13:10
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_121230.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251110_121230.csv`
...
- **MFE Promedio:** 68.77 pts (máxima ganancia flotante)
- **MAE Promedio:** 8.76 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 452.51

**Dirección Inicial (primeras 3 barras @ 5m):**

| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 80 | 83.3% |
| SL_FIRST (precio fue hacia SL) | 12 | 12.5% |
| NEUTRAL (sin dirección clara) | 4 | 4.2% |

**Calidad de Entradas:**

- **Entradas Buenas (MFE > MAE):** 90.6%
- **Entradas Malas (MAE > MFE):** 9.4%

**🔍 Análisis por Estado (Modo Diagnóstico):**

| Estado | Count | TP_FIRST | SL_FIRST | TP_FIRST % | MFE Avg | MAE Avg |
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 8 | 3 | 4 | 37.5% | 57.25 | 15.97 |
| PENDING | 86 | 75 | 8 | 87.2% | 69.46 | 8.17 |
...
**Rationale:** Basado en percentil 90 de operaciones reales (SL: 45.8pts, TP: 75.5pts)
