...
**Fecha:** 2025-11-10 11:43:04
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_114156.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251110_114156.csv`
...
- **MFE Promedio:** 68.92 pts (máxima ganancia flotante)
- **MAE Promedio:** 8.36 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 460.24
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 7 | 4 | 2 | 57.1% | 74.75 | 9.07 |
| PENDING | 81 | 68 | 10 | 84.0% | 68.02 | 8.37 |
...
public int MaxTPDistancePoints { get; set; } = 74; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 44.6pts, TP: 74.8pts)
...
2. **MaxTPDistancePoints:** 120 → **74** (P90 real)
