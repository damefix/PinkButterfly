...
**Fecha:** 2025-11-17 11:40:16
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251117_113102.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251117_113102.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 79678 | 100.0% | 100.0% |
| ProximityAnalyzer | 1740 | 2.2% | 2.2% |
| DFM_Evaluated | 359 | 20.6% | 0.5% |
| DFM_Passed | 359 | 100.0% | 0.5% |
| RiskCalculator | 3817 | 1063.2% | 4.8% |
| Risk_Accepted | 1 | 0.0% | 0.0% |
| TradeManager | 12 | 1200.0% | 0.0% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 3816 señales, -100.0%)
- **Tasa de conversión final:** 0.02% (de 79678 zonas iniciales → 12 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 793 | 52.3% |
| ENTRY_TOO_FAR | 414 | 27.3% |
| NO_SL | 162 | 10.7% |
| TP_CHECK_FAIL | 148 | 9.8% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (793 rechazos, 52.3%)
...
**Total de Phantom Opportunities analizadas:** 809

**Calidad por Rango de Distancia:**

| Rango Distancia | Count | WR Teórico | TP_FIRST % | MFE/MAE Ratio | Good Entries % | Avg R:R | Conclusión |
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 268 | 45.5% | 35.1% | 5.16 | 46.3% | 2.28 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 98 | 79.6% | 52.0% | 7.32 | 79.6% | 1.90 | ✅ BUENA CALIDAD - Considerar incluir |
...
**0.0-2.0 ATR (Muy cerca)** (268 oportunidades)

- **WR Teórico:** 45.5% (si se hubieran ejecutado)
- **TP_FIRST:** 35.1% (94 de 268)
- **SL_FIRST:** 54.1% (145 de 268)
...
- **WR Teórico:** 79.6% (si se hubieran ejecutado)
- **TP_FIRST:** 52.0% (51 de 98)
- **SL_FIRST:** 43.9% (43 de 98)
- **MFE Promedio:** 65.84 pts
- **MAE Promedio:** 18.91 pts
- **MFE/MAE Ratio:** 7.32
- **Good Entries:** 79.6% (MFE > MAE)
- **R:R Promedio:** 1.90
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 12 | 268 | 98 | 249 |
| **TP_FIRST %** | 50.0% | 35.1% | 52.0% | 55.4% |
| **Good Entries %** | 83.3% | 46.3% | 79.6% | 61.0% |
| **MFE/MAE Ratio** | 3.16 | 5.16 | 7.32 | 3.14 |

**💡 RECOMENDACIONES BASADAS EN DATOS:**

🚨 **CRÍTICO: El rango 2.0-3.0 ATR contiene 98 oportunidades de BUENA CALIDAD**
   - WR Teórico: 79.6%
   - Good Entries: 79.6%
