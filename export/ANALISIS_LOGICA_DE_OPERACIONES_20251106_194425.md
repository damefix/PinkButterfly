...
**Fecha:** 2025-11-06 19:50:39
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251106_194425.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251106_194425.csv`
...
- **Operaciones Ejecutadas:** 115
- **Win Rate:** 0.0% (0/115)
- **Profit Factor:** 1.26
- **Avg R:R Planeado:** 50.94
...
| ProximityAnalyzer | 18412 | 0.0% |
| DFM | 0 | 0.0% |
| RiskCalculator | 0 | 0.0% |
| TradeManager | 115 | 0.0% |
...
public int MaxTPDistancePoints { get; set; } = 83; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 82.7pts, TP: 83.4pts)
...
**Estado actual:** R:R promedio = 50.94
**Gap:** -49.19 (necesitas mejorar R:R)
...
2. **MaxTPDistancePoints:** 120 → **83** (P90 real)
...
**Problema:** R:R actual (50.94) < R:R mínimo (1.75)
