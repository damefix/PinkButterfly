...
**Fecha:** 2025-11-06 12:25:04
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251106_121741.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251106_121741.csv`
...
- **Operaciones Ejecutadas:** 85
- **Win Rate:** 0.0% (0/85)
- **Profit Factor:** 1.02
- **Avg R:R Planeado:** 45.51
...
```csharp
// En EngineConfig.cs
public int MaxSLDistancePoints { get; set; } = 90; // Era 60
public int MaxTPDistancePoints { get; set; } = 75; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 90.1pts, TP: 75.4pts)
...
**Estado actual:** R:R promedio = 45.51
**Gap:** -43.76 (necesitas mejorar R:R)
...
**Solución:**
1. **MaxSLDistancePoints:** 60 → **90** (P90 real)
...
**Problema:** R:R actual (45.51) < R:R mínimo (1.75)
