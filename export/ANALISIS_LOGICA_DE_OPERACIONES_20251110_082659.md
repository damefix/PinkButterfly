...
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_082659.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251110_082659.csv`
...
public int MaxTPDistancePoints { get; set; } = 95; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 49.3pts, TP: 95.2pts)
...
**Estado actual:** R:R promedio = 1.61
...
2. **MaxTPDistancePoints:** 120 → **95** (P90 real)
...
**Problema:** R:R actual (1.61) < R:R mínimo (1.75)
