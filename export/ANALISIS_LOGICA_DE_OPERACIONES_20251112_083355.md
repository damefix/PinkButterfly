...
**Fecha:** 2025-11-12 08:37:46
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251112_083355.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251112_083355.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 39845 | 100.0% | 100.0% |
| ProximityAnalyzer | 7 | 0.0% | 0.0% |
| DFM_Evaluated | 208 | 2971.4% | 0.5% |
| DFM_Passed | 188 | 90.4% | 0.5% |
| RiskCalculator | 49 | 26.1% | 0.1% |
| TradeManager | 37 | 75.5% | 0.1% |

**Análisis:**
- **Mayor caída:** ProximityAnalyzer (pierde 39838 señales, -100.0%)
- **Tasa de conversión final:** 0.09% (de 39845 zonas iniciales → 37 operaciones)

### 3.2 Distribución por Tipo de TP

| Tipo TP | Count | % |
|---------|-------|---|
| P0_SWING_LITE | 395 | 92.1% |
| P0_ANY_DIR | 34 | 7.9% |
...
- **MFE Promedio:** 30.51 pts (máxima ganancia flotante)
- **MAE Promedio:** 44.51 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 1.54
...
| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 15 | 40.5% |
| SL_FIRST (precio fue hacia SL) | 21 | 56.8% |
| NEUTRAL (sin dirección clara) | 1 | 2.7% |

**Calidad de Entradas:**

- **Entradas Buenas (MFE > MAE):** 32.4%
- **Entradas Malas (MAE > MFE):** 67.6%
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 37 | 15 | 21 | 40.5% | 30.51 | 44.51 |
...
| T0010_3 | SELL | 137.50 | 27.75 | 4.95 | TP_FIRST | CLOSED | ✅ Entrada excelente |
| T0011 | SELL | 19.50 | 49.00 | 0.40 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0012 | SELL | 29.00 | 42.25 | 0.69 | SL_FIRST | CLOSED | ⚠️ Entrada dudosa |
| T0013 | BUY | 36.50 | 82.00 | 0.45 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0015 | SELL | 0.00 | 90.75 | 0.00 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0018 | BUY | 14.75 | 16.25 | 0.91 | SL_FIRST | CLOSED | ⚠️ Entrada dudosa |
| T0020 | BUY | 12.00 | 60.25 | 0.20 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0023 | SELL | 16.00 | 34.75 | 0.46 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0024 | SELL | 5.50 | 162.75 | 0.03 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0024_2 | SELL | 5.50 | 162.75 | 0.03 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0026 | BUY | 27.25 | 10.50 | 2.60 | SL_FIRST | CLOSED | ✅ Entrada excelente |
| T0027 | BUY | 16.50 | 2.25 | 7.33 | TP_FIRST | CLOSED | ✅ Entrada excelente |
...
**Gap:** 0.97 (necesitas mejorar R:R)
...
**Problema:** R:R actual (1.73) < R:R mínimo (2.70)
