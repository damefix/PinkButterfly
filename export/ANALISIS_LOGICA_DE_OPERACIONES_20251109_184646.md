...
**Fecha:** 2025-11-09 18:47:21
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251109_184646.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251109_184646.csv`
...
2. **LÍMITES SL/TP NO CALIBRADOS PARA INTRADÍA:**
   - SL máximo observado: 76 puntos
   - TP máximo observado: 75 puntos
...
```csharp
// En EngineConfig.cs
public int MaxSLDistancePoints { get; set; } = 75; // Era 60
public int MaxTPDistancePoints { get; set; } = 105; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 75.7pts, TP: 105.2pts)
...
**Estado actual:** R:R promedio = 50.43
**Gap:** -48.68 (necesitas mejorar R:R)
...
**Solución:**
1. **MaxSLDistancePoints:** 60 → **75** (P90 real)
2. **MaxTPDistancePoints:** 120 → **105** (P90 real)
...
**Problema:** R:R actual (50.43) < R:R mínimo (1.75)
