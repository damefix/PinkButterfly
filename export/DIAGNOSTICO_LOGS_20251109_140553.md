# Informe Diagnóstico de Logs - 2025-11-09 14:06:35

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251109_140553.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251109_140553.csv`
...
### TP Policy (V6.0c)
- **FORCED_P3:** 0 (0.0%)
- **P4_FALLBACK:** 92 (100.0%)

### TP P0 HeatZone-Based (V6.0f-FASE2)
- **P0_ANY_DIR:** 1 (1.1% del total)
...
### Take Profit (TP)
- Zonas analizadas: 96 | Total candidatos: 381 | Seleccionados: 96
- Candidatos por zona (promedio): 4.0
- **Edad (barras)** - Candidatos: med=41, max=110 | Seleccionados: med=0, max=37
- **Score** - Candidatos: avg=0.38 | Seleccionados: avg=0.01
- **Priority Candidatos**: {'P3': 381}
- **Priority Seleccionados**: {'P4_Fallback': 92, 'P3': 4}
- **Type Candidatos**: {'Swing': 381}
- **Type Seleccionados**: {'Calculated': 92, 'Swing': 4}
- **TF Candidatos**: {5: 189, 15: 161, 60: 27, 240: 4}
- **TF Seleccionados**: {-1: 92, 5: 4}
- **DistATR** - Candidatos: avg=8.7 | Seleccionados: avg=7.0
- **RR** - Candidatos: avg=1.22 | Seleccionados: avg=1.01
- **Razones de selección**: {'NoStructuralTarget': 92, 'Intradía(15→5→60→240)': 4}

### 🎯 Recomendaciones
- ⚠️ SL: 74% tienen score < 0.5. Considerar umbral mínimo de calidad.
- ⚠️ TP: 96% son fallback (sin estructura válida). Problema de calidad de estructuras.
