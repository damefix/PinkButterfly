...
**Fecha:** 2025-11-12 10:29:41
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251112_102618.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251112_102618.csv`
...
- **R:R Mínimo para Break-Even:** 4.50
...
|------|---------------|---------------|------------|
| StructureFusion | 8492 | 100.0% | 100.0% |
| ProximityAnalyzer | 6 | 0.1% | 0.1% |
| DFM_Evaluated | 172 | 2866.7% | 2.0% |
| DFM_Passed | 162 | 94.2% | 1.9% |
| RiskCalculator | 47 | 29.0% | 0.6% |
| TradeManager | 33 | 70.2% | 0.4% |

**Análisis:**
- **Mayor caída:** ProximityAnalyzer (pierde 8486 señales, -99.9%)
- **Tasa de conversión final:** 0.39% (de 8492 zonas iniciales → 33 operaciones)

### 3.2 Distribución por Tipo de TP

| Tipo TP | Count | % |
|---------|-------|---|
| P0_SWING_LITE | 344 | 91.5% |
| P0_ANY_DIR | 32 | 8.5% |
...
- **MFE Promedio:** 28.86 pts (máxima ganancia flotante)
- **MAE Promedio:** 46.18 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 1.31
...
| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 12 | 36.4% |
| SL_FIRST (precio fue hacia SL) | 20 | 60.6% |
| NEUTRAL (sin dirección clara) | 1 | 3.0% |

**Calidad de Entradas:**

- **Entradas Buenas (MFE > MAE):** 27.3%
- **Entradas Malas (MAE > MFE):** 72.7%
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 33 | 12 | 20 | 36.4% | 28.86 | 46.18 |
...
|----------|-----|-----------|-----------|-------|-------------|-----------|-------------|
| T0004 | BUY | 11.75 | 43.75 | 0.27 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0004_2 | BUY | 11.75 | 43.75 | 0.27 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
...
| T0013 | SELL | 154.00 | 21.25 | 7.25 | TP_FIRST | CLOSED | ✅ Entrada excelente |
| T0013_2 | SELL | 154.00 | 21.25 | 7.25 | TP_FIRST | CLOSED | ✅ Entrada excelente |
...
| T0020 | SELL | 12.25 | 109.00 | 0.11 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0022 | BUY | 12.00 | 41.50 | 0.29 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0024 | SELL | 5.50 | 41.25 | 0.13 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0025 | SELL | 0.00 | 171.25 | 0.00 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0027 | BUY | 26.00 | 10.50 | 2.48 | SL_FIRST | CLOSED | ✅ Entrada excelente |
| T0028 | BUY | 16.00 | 48.25 | 0.33 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0030 | BUY | 24.50 | 37.75 | 0.65 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
...
**Para Win Rate actual (18.2%), el R:R mínimo es:**

```
R:R_min = (1 - WR) / WR
R:R_min = (1 - 0.182) / 0.182
R:R_min = 4.50
```

**Estado actual:** R:R promedio = 1.73
**Gap:** 2.77 (necesitas mejorar R:R)
...
**Problema:** R:R actual (1.73) < R:R mínimo (4.50)
...
**Impacto esperado:** Sistema break-even con WR=18.2%
