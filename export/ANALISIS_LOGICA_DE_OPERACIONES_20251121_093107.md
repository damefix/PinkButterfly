...
**Fecha:** 2025-11-21 09:39:05
**LOG:** `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251121_093107.log`
**CSV:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251121_093107.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 49411 | 100.0% | 100.0% |
| ProximityAnalyzer | 3857 | 7.8% | 7.8% |
| DFM_Evaluated | 282 | 7.3% | 0.6% |
| DFM_Passed | 282 | 100.0% | 0.6% |
| RiskCalculator | 8152 | 2890.8% | 16.5% |
| Risk_Accepted | 9 | 0.1% | 0.0% |
| TradeManager | 6 | 66.7% | 0.0% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 8143 señales, -99.9%)
- **Tasa de conversión final:** 0.01% (de 49411 zonas iniciales → 6 operaciones)
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 6 | 5 | 1 | 83.3% | 109.42 | 11.58 |
...
**Total de Phantom Opportunities analizadas:** 400

**Calidad por Rango de Distancia:**

| Rango Distancia | Count | WR Teórico | TP_FIRST % | MFE/MAE Ratio | Good Entries % | Avg R:R | Conclusión |
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 168 | 93.5% | 91.1% | 14.78 | 97.0% | 2.00 | ✅ BUENA CALIDAD - Considerar incluir |
| 2.0-3.0 ATR (Cerca) | 69 | 87.0% | 78.3% | 14.71 | 95.7% | 2.12 | ✅ BUENA CALIDAD - Considerar incluir |
| 3.0-5.0 ATR (Media) | 83 | 88.0% | 84.3% | 16.16 | 88.0% | 2.17 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 57 | 93.0% | 94.7% | 13.05 | 94.7% | 2.01 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 23 | 100.0% | 100.0% | 12.54 | 100.0% | 2.22 | ✅ BUENA CALIDAD - Considerar incluir |

**📈 Análisis Detallado por Rango:**

**0.0-2.0 ATR (Muy cerca)** (168 oportunidades)

- **WR Teórico:** 93.5% (si se hubieran ejecutado)
- **TP_FIRST:** 91.1% (153 de 168)
- **SL_FIRST:** 7.7% (13 de 168)
- **MFE Promedio:** 123.35 pts
- **MAE Promedio:** 10.97 pts
- **MFE/MAE Ratio:** 14.78
- **Good Entries:** 97.0% (MFE > MAE)
- **R:R Promedio:** 2.00
...
- **WR Teórico:** 87.0% (si se hubieran ejecutado)
- **TP_FIRST:** 78.3% (54 de 69)
- **SL_FIRST:** 18.8% (13 de 69)
- **MFE Promedio:** 115.39 pts
- **MAE Promedio:** 11.49 pts
- **MFE/MAE Ratio:** 14.71
...
- **WR Teórico:** 88.0% (si se hubieran ejecutado)
- **TP_FIRST:** 84.3% (70 de 83)
- **SL_FIRST:** 3.6% (3 de 83)
- **MFE Promedio:** 137.86 pts
- **MAE Promedio:** 11.02 pts
- **MFE/MAE Ratio:** 16.16
- **Good Entries:** 88.0% (MFE > MAE)
- **R:R Promedio:** 2.17
...
- **WR Teórico:** 93.0% (si se hubieran ejecutado)
- **TP_FIRST:** 94.7% (54 de 57)
- **SL_FIRST:** 0.0% (0 de 57)
- **MFE Promedio:** 132.14 pts
- **MAE Promedio:** 9.92 pts
- **MFE/MAE Ratio:** 13.05
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 6 | 168 | 69 | 83 |
| **TP_FIRST %** | 83.3% | 91.1% | 78.3% | 84.3% |
| **Good Entries %** | 100.0% | 97.0% | 95.7% | 88.0% |
| **MFE/MAE Ratio** | 337.43 | 14.78 | 14.71 | 16.16 |
