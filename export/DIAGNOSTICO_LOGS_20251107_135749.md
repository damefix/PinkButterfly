# Informe Diagnóstico de Logs - 2025-11-07 14:02:57

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251107_135749.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251107_135749.csv`
...
- Matched aceptaciones con CSV: 95 | Unmatched: 183
- 0-10: Wins=66 Losses=29 WR=69.5% (n=95)
...
- 0.50-0.60: Wins=66 Losses=29 WR=69.5% (n=95)
...
## CSV de Trades
- Filas: 20 | Ejecutadas: 7 | Canceladas: 0 | Expiradas: 0
- BUY: 27 | SELL: 0

## 📊 Embudo de Señales (Funnel)
- DFM Señales (PassedThreshold): 181
- Registered: 10
  - DEDUP_COOLDOWN: 0 | DEDUP_IDENTICAL: 2 | SKIP_CONCURRENCY: 6
...
|--------|------------:|------------:|-----------:|
| a95c2ba7-7fa6-42ef-9b9a-3c926f6c84e4 | 1 | 50.0% | 6139,50/6111,59/6203,00 |
| 9ced15bb-6321-4a73-ad8f-0733913d6d31 | 1 | 50.0% | 6141,50/6112,45/6203,00 |
...
- IDENTICAL por Acción: {'BUY': 2, 'SELL': 0}
- IDENTICAL por DomTF: {'60': 2}

### Ratios del Funnel
- Coverage = Intentos / PassedThreshold = 9.9%
- RegRate = Registered / Intentos = 55.6%
- Dedup Rate = (COOLDOWN+IDENTICAL) / Intentos = 11.1%
- Concurrency = SKIP_CONCURRENCY / Intentos = 33.3%
- ExecRate = Ejecutadas / Registered = 70.0%
