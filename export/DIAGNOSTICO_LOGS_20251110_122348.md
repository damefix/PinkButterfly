# Informe Diagnóstico de Logs - 2025-11-10 12:25:20

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_122348.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251110_122348.csv`
...
- Dir zonas (zona): Bull=868 Bear=7105 Neutral=192
- Resumen por ciclo (promedios): TotHZ≈ 3.0, WithAnchors≈ 3.0, DirBull≈ 0.6, DirBear≈ 2.3, DirNeutral≈ 0.1
- Razones de dirección: {'anchors+triggers': 7973, 'tie-bias': 192}
...
### Stop Loss (SL)
- Zonas analizadas: 735 | Total candidatos: 8685 | Seleccionados: 0
- Candidatos por zona (promedio): 11.8

### Take Profit (TP)
- Zonas analizadas: 735 | Total candidatos: 8308 | Seleccionados: 0
...
- **Priority Candidatos**: {'P3': 8308}
- **Priority Seleccionados**: {}
- **Type Candidatos**: {'Swing': 8308}
- **Type Seleccionados**: {}
- **TF Candidatos**: {240: 3115, 60: 2193, 15: 2182, 5: 818}
- **TF Seleccionados**: {}
