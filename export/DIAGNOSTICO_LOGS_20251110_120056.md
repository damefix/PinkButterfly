# Informe Diagnóstico de Logs - 2025-11-10 12:01:22

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_120056.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251110_120056.csv`
...
## StructureFusion
- Trazas por zona: 2903 | Zonas con Anchors: 2903
- Dir zonas (zona): Bull=494 Bear=2405 Neutral=4
- Resumen por ciclo (promedios): TotHZ≈ 1.7, WithAnchors≈ 1.7, DirBull≈ 0.1, DirBear≈ 1.5, DirNeutral≈ 0.0
- Razones de dirección: {'tie-bias': 4, 'anchors+triggers': 2899}
...
### Stop Loss (SL)
- Zonas analizadas: 426 | Total candidatos: 5995 | Seleccionados: 0
- Candidatos por zona (promedio): 14.1

### Take Profit (TP)
- Zonas analizadas: 426 | Total candidatos: 4756 | Seleccionados: 0
...
- **Priority Candidatos**: {'P3': 4756}
- **Priority Seleccionados**: {}
- **Type Candidatos**: {'Swing': 4756}
- **Type Seleccionados**: {}
- **TF Candidatos**: {240: 1660, 15: 1543, 60: 852, 5: 701}
- **TF Seleccionados**: {}
