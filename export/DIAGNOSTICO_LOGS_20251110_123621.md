# Informe Diagnóstico de Logs - 2025-11-10 12:37:21

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_123621.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251110_123621.csv`

## DFM
- Eventos de evaluación: 164
- Evaluaciones Bull: 16 | Bear: 318
- Pasaron umbral (PassedThreshold): 334
- ConfidenceBins acumulado: 0:0, 1:0, 2:0, 3:0, 4:3, 5:10, 6:54, 7:138, 8:129, 9:0
...
## Risk
- Eventos: 270
- Accepted=334 | RejSL=0 | RejTP=0 | RejRR=173 | RejEntry=0
### TP P0 HeatZone-Based (V6.0f-FASE2)
- **P0_ANY_DIR:** 119 (49.0% del total)
  - Avg Score: 0.65 | Avg R:R: 1.95 | Avg DistATR: 8.86
  - Por TF: TF5=70, TF15=49
- **P0_SWING_LITE:** 124 (51.0% del total)
...
- RR plan por bandas: 0-10≈ 1.66 (n=332), 10-15≈ 1.79 (n=2)
...
## StructureFusion
- Trazas por zona: 8188 | Zonas con Anchors: 8188
- Dir zonas (zona): Bull=997 Bear=7043 Neutral=148
- Resumen por ciclo (promedios): TotHZ≈ 3.0, WithAnchors≈ 3.0, DirBull≈ 0.6, DirBear≈ 2.2, DirNeutral≈ 0.2
- Razones de dirección: {'anchors+triggers': 8040, 'tie-bias': 148}
...
### Stop Loss (SL)
- Zonas analizadas: 652 | Total candidatos: 7996 | Seleccionados: 0
- Candidatos por zona (promedio): 12.3

### Take Profit (TP)
- Zonas analizadas: 652 | Total candidatos: 9953 | Seleccionados: 0
...
- **Priority Candidatos**: {'P3': 9953}
- **Priority Seleccionados**: {}
- **Type Candidatos**: {'Swing': 9953}
- **Type Seleccionados**: {}
- **TF Candidatos**: {240: 5197, 15: 2283, 60: 1656, 5: 817}
- **TF Seleccionados**: {}
