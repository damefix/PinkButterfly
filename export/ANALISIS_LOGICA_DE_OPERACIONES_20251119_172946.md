...
|------|---------------|---------------|------------|
| StructureFusion | 22416 | 100.0% | 100.0% |
| ProximityAnalyzer | 2997 | 13.4% | 13.4% |
| DFM_Evaluated | 373 | 12.4% | 1.7% |
| DFM_Passed | 373 | 100.0% | 1.7% |
| RiskCalculator | 5679 | 1522.5% | 25.3% |
| Risk_Accepted | 1 | 0.0% | 0.0% |
| TradeManager | 5 | 500.0% | 0.0% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 5678 señales, -100.0%)
- **Tasa de conversión final:** 0.02% (de 22416 zonas iniciales → 5 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,977 | 60.3% |
| ENTRY_TOO_FAR | 698 | 21.3% |
| TP_CHECK_FAIL | 336 | 10.3% |
| NO_SL | 267 | 8.1% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,977 rechazos, 60.3%)
...
**Total de Phantom Opportunities analizadas:** 604
...
| 2.0-3.0 ATR (Cerca) | 97 | 19.6% | 22.7% | 0.45 | 20.6% | 2.31 | ❌ BAJA CALIDAD - Filtro correcto |
...
**2.0-3.0 ATR (Cerca)** (97 oportunidades)

- **WR Teórico:** 19.6% (si se hubieran ejecutado)
- **TP_FIRST:** 22.7% (22 de 97)
- **SL_FIRST:** 77.3% (75 de 97)
- **MFE Promedio:** 47.78 pts
- **MAE Promedio:** 72.57 pts
- **MFE/MAE Ratio:** 0.45
- **Good Entries:** 20.6% (MFE > MAE)
- **R:R Promedio:** 2.31
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 5 | 182 | 97 | 195 |
| **TP_FIRST %** | 40.0% | 14.8% | 22.7% | 43.1% |
| **Good Entries %** | 60.0% | 15.9% | 20.6% | 35.9% |
| **MFE/MAE Ratio** | 202.81 | 0.77 | 0.45 | 0.68 |

**💡 RECOMENDACIONES BASADAS EN DATOS:**

✅ **CORRECTO: El filtro 2.0 ATR está bloqueando 97 oportunidades de BAJA calidad**
   - WR Teórico: 19.6%
