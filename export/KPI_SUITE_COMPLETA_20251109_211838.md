...
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251109_211838.csv`  
**Trades Analizados:** 1
...
**Análisis de 9 evaluaciones de HeatZones**
...
| **Proximity** | 0.2662 | 37.7% |
| **Confluence** | 0.1500 | 21.2% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.1335 | 18.9% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.7064 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 9
- **Señales generadas:** 9 (100.0%)
