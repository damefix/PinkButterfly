...
**Fecha:** 2025-11-09 13:14:14  
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251109_131344.csv`  
**Trades Analizados:** 1
...
**Análisis de 6 evaluaciones de HeatZones**
...
| **Proximity** | 0.3975 | 56.5% |
| **Confluence** | 0.1500 | 21.3% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.0000 | 0.0% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.7037 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 6
- **Señales generadas:** 6 (100.0%)
