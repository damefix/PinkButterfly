# Informe Diagnóstico de Logs - 2025-11-21 10:12:44
...
- **P0_SWING_LITE:** 2184 (69.2% del total)
  - Avg Score: 0.82 | Avg R:R: 2.95 | Avg DistATR: 4.09
  - Por TF: TF15=263, TF60=1921
...
## StructureFusion
- Trazas por zona: 50556 | Zonas con Anchors: 50556
- Dir zonas (zona): Bull=3523 Bear=46373 Neutral=660
- Resumen por ciclo (promedios): TotHZ≈ 16.2, WithAnchors≈ 16.2, DirBull≈ 1.1, DirBear≈ 14.8, DirNeutral≈ 0.2
- Razones de dirección: {'anchors+triggers': 49564, 'tie-bias': 992}
- TF Triggers: {'5': 32066, '15': 18490}
- TF Anchors: {'1440': 50556, '240': 50556, '60': 50556}
...
### Take Profit (TP)
- Zonas analizadas: 8023 | Total candidatos: 326784 | Seleccionados: 8023
- Candidatos por zona (promedio): 40.7
- **Edad (barras)** - Candidatos: med=1063, max=8001 | Seleccionados: med=0, max=0
- **Score** - Candidatos: avg=0.80 | Seleccionados: avg=0.66
- **Priority Candidatos**: {'P3': 185940}
- **Priority Seleccionados**: {'P3': 7278, 'NA': 529, 'P0': 216}
- **Type Candidatos**: {'Swing': 185940}
- **Type Seleccionados**: {'P3_Swing': 7278, 'P4_Fallback': 529, 'P0_Zone': 216}
- **TF Candidatos**: {5: 89436, 15: 52900, 240: 23997, 60: 19607}
- **TF Seleccionados**: {5: 4932, 240: 1744, 15: 601, -1: 529, 60: 217}
