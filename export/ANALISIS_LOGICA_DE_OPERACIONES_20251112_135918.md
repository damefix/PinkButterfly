...
**Fecha:** 2025-11-12 14:01:49
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251112_135918.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251112_135918.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 10221 | 100.0% | 100.0% |
| ProximityAnalyzer | 2140 | 20.9% | 20.9% |
| DFM_Evaluated | 272 | 12.7% | 2.7% |
| DFM_Passed | 257 | 94.5% | 2.5% |
| RiskCalculator | 66 | 25.7% | 0.6% |
| TradeManager | 35 | 53.0% | 0.3% |

**Análisis:**
- **Mayor caída:** DFM_Evaluated (pierde 1868 señales, -87.3%)
- **Tasa de conversión final:** 0.34% (de 10221 zonas iniciales → 35 operaciones)
...
- **MFE Promedio:** 31.94 pts (máxima ganancia flotante)
- **MAE Promedio:** 35.63 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 6.10
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 35 | 14 | 19 | 40.0% | 31.94 | 35.63 |
...
| T0003 | SELL | 0.00 | 46.75 | 0.00 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
...
| T0019 | SELL | 19.75 | 87.50 | 0.23 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
...
**Problema:** R:R actual (2.46) < R:R mínimo (1.92)
