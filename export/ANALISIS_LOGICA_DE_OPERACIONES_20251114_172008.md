...
**Fecha:** 2025-11-14 17:25:05
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251114_172008.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251114_172008.csv`
...
| ProximityAnalyzer | 3299 | 31.5% | 31.5% |
| DFM_Evaluated | 765 | 23.2% | 7.3% |
| DFM_Passed | 765 | 100.0% | 7.3% |
| RiskCalculator | 6035 | 788.9% | 57.6% |
| Risk_Accepted | 1 | 0.0% | 0.0% |
| TradeManager | 40 | 4000.0% | 0.4% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6034 señales, -100.0%)
- **Tasa de conversión final:** 0.38% (de 10479 zonas iniciales → 40 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,283 | 48.2% |
| NO_SL | 757 | 28.5% |
| ENTRY_TOO_FAR | 404 | 15.2% |
| TP_CHECK_FAIL | 216 | 8.1% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,283 rechazos, 48.2%)
...
- **MFE Promedio:** 42.41 pts (máxima ganancia flotante)
...
| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 18 | 45.0% |
| SL_FIRST (precio fue hacia SL) | 19 | 47.5% |
| NEUTRAL (sin dirección clara) | 3 | 7.5% |

**Calidad de Entradas:**

- **Entradas Buenas (MFE > MAE):** 52.5%
- **Entradas Malas (MAE > MFE):** 47.5%

**🔍 Análisis por Estado (Modo Diagnóstico):**

| Estado | Count | TP_FIRST | SL_FIRST | TP_FIRST % | MFE Avg | MAE Avg |
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 40 | 18 | 19 | 45.0% | 42.41 | 28.09 |
...
| T0003_2 | BUY | 1.75 | 18.75 | 0.09 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
...
**Total de Phantom Opportunities analizadas:** 1,252

**Calidad por Rango de Distancia:**

| Rango Distancia | Count | WR Teórico | TP_FIRST % | MFE/MAE Ratio | Good Entries % | Avg R:R | Conclusión |
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 462 | 26.4% | 57.8% | 3.58 | 42.2% | 2.00 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 244 | 51.2% | 56.1% | 2.88 | 52.9% | 1.93 | ⚠️ CALIDAD MEDIA - Revisar |
| 3.0-5.0 ATR (Media) | 322 | 69.3% | 59.6% | 5.36 | 63.0% | 2.03 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 213 | 74.6% | 73.7% | 1.70 | 73.7% | 2.20 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 11 | 36.4% | 36.4% | 0.00 | 36.4% | 3.10 | ❌ BAJA CALIDAD - Filtro correcto |

**📈 Análisis Detallado por Rango:**

**0.0-2.0 ATR (Muy cerca)** (462 oportunidades)

- **WR Teórico:** 26.4% (si se hubieran ejecutado)
- **TP_FIRST:** 57.8% (267 de 462)
- **SL_FIRST:** 38.7% (179 de 462)
- **MFE Promedio:** 44.18 pts
- **MAE Promedio:** 43.94 pts
- **MFE/MAE Ratio:** 3.58
...
- **TP_FIRST:** 56.1% (137 de 244)
- **SL_FIRST:** 43.0% (105 de 244)
- **MFE Promedio:** 64.96 pts
- **MAE Promedio:** 39.93 pts
- **MFE/MAE Ratio:** 2.88
- **Good Entries:** 52.9% (MFE > MAE)
- **R:R Promedio:** 1.93

**⚠️ CALIDAD MEDIA - Revisar**

**3.0-5.0 ATR (Media)** (322 oportunidades)

- **WR Teórico:** 69.3% (si se hubieran ejecutado)
- **TP_FIRST:** 59.6% (192 de 322)
- **SL_FIRST:** 40.1% (129 de 322)
- **MFE Promedio:** 82.76 pts
- **MAE Promedio:** 42.30 pts
- **MFE/MAE Ratio:** 5.36
...
- **WR Teórico:** 74.6% (si se hubieran ejecutado)
- **TP_FIRST:** 73.7% (157 de 213)
- **SL_FIRST:** 26.3% (56 de 213)
- **MFE Promedio:** 91.30 pts
- **MAE Promedio:** 50.11 pts
- **MFE/MAE Ratio:** 1.70
- **Good Entries:** 73.7% (MFE > MAE)
- **R:R Promedio:** 2.20
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 40 | 462 | 244 | 322 |
| **TP_FIRST %** | 45.0% | 57.8% | 56.1% | 59.6% |
| **Good Entries %** | 52.5% | 42.2% | 52.9% | 63.0% |
| **MFE/MAE Ratio** | 28.15 | 3.58 | 2.88 | 5.36 |

**💡 RECOMENDACIONES BASADAS EN DATOS:**

⚠️ **ATENCIÓN: El rango 3.0-5.0 ATR contiene 322 oportunidades con calidad MEDIA-ALTA**
   - WR Teórico: 69.3%
   - Good Entries: 63.0%
...
**Gap:** -0.55 (necesitas mejorar R:R)
...
**Problema:** R:R actual (2.05) < R:R mínimo (1.50)
