...
**Fecha:** 2025-11-13 08:40:35
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251113_083643.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251113_083643.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 10317 | 100.0% | 100.0% |
| ProximityAnalyzer | 4159 | 40.3% | 40.3% |
| DFM_Evaluated | 850 | 20.4% | 8.2% |
| DFM_Passed | 850 | 100.0% | 8.2% |
| RiskCalculator | 6303 | 741.5% | 61.1% |
| Risk_Accepted | 104 | 1.7% | 1.0% |
| TradeManager | 35 | 33.7% | 0.3% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6199 señales, -98.3%)
- **Tasa de conversión final:** 0.34% (de 10317 zonas iniciales → 35 operaciones)
...
- **MFE Promedio:** 44.27 pts (máxima ganancia flotante)
- **MAE Promedio:** 30.30 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 60.23
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 35 | 23 | 11 | 65.7% | 44.27 | 30.30 |
...
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 477 | 38.4% | 60.8% | 4.05 | 45.9% | 2.02 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 249 | 50.2% | 53.0% | 1.70 | 48.6% | 1.91 | ❌ BAJA CALIDAD - Filtro correcto |
| 3.0-5.0 ATR (Media) | 362 | 69.3% | 56.6% | 2.89 | 60.8% | 2.07 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 205 | 69.3% | 64.9% | 0.87 | 67.8% | 2.39 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 16 | 50.0% | 37.5% | 0.12 | 37.5% | 3.40 | ❌ BAJA CALIDAD - Filtro correcto |

**📈 Análisis Detallado por Rango:**

**0.0-2.0 ATR (Muy cerca)** (477 oportunidades)

- **WR Teórico:** 38.4% (si se hubieran ejecutado)
- **TP_FIRST:** 60.8% (290 de 477)
- **SL_FIRST:** 36.9% (176 de 477)
- **MFE Promedio:** 49.81 pts
- **MAE Promedio:** 39.20 pts
- **MFE/MAE Ratio:** 4.05
...
- **TP_FIRST:** 53.0% (132 de 249)
- **SL_FIRST:** 47.0% (117 de 249)
- **MFE Promedio:** 57.05 pts
...
- **TP_FIRST:** 56.6% (205 de 362)
- **SL_FIRST:** 43.4% (157 de 362)
- **MFE Promedio:** 69.49 pts
- **MAE Promedio:** 42.35 pts
- **MFE/MAE Ratio:** 2.89
...
**5.0-10.0 ATR (Lejos)** (205 oportunidades)

- **WR Teórico:** 69.3% (si se hubieran ejecutado)
- **TP_FIRST:** 64.9% (133 de 205)
- **SL_FIRST:** 35.1% (72 de 205)
- **MFE Promedio:** 80.58 pts
- **MAE Promedio:** 51.33 pts
- **MFE/MAE Ratio:** 0.87
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 35 | 477 | 249 | 362 |
| **TP_FIRST %** | 65.7% | 60.8% | 53.0% | 56.6% |
| **Good Entries %** | 45.7% | 45.9% | 48.6% | 60.8% |
| **MFE/MAE Ratio** | 60.23 | 4.05 | 1.70 | 2.89 |
