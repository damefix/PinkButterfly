...
**Fecha:** 2025-11-13 08:08:53
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251113_080406.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251113_080406.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 10304 | 100.0% | 100.0% |
| ProximityAnalyzer | 4130 | 40.1% | 40.1% |
| DFM_Evaluated | 841 | 20.4% | 8.2% |
| DFM_Passed | 841 | 100.0% | 8.2% |
| RiskCalculator | 6294 | 748.4% | 61.1% |
| Risk_Accepted | 113 | 1.8% | 1.1% |
| TradeManager | 43 | 38.1% | 0.4% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6181 señales, -98.2%)
- **Tasa de conversión final:** 0.42% (de 10304 zonas iniciales → 43 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,649 | 59.1% |
| NO_SL | 517 | 18.5% |
| ENTRY_TOO_FAR | 369 | 13.2% |
| TP_CHECK_FAIL | 255 | 9.1% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,649 rechazos, 59.1%)
...
- **MFE Promedio:** 45.90 pts (máxima ganancia flotante)
- **MAE Promedio:** 28.27 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 52.05
...
| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 24 | 55.8% |
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 43 | 24 | 18 | 55.8% | 45.90 | 28.27 |
...
| T0037 | SELL | 27.25 | 80.00 | 0.34 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
...
**Total de Phantom Opportunities analizadas:** 1,320

**Calidad por Rango de Distancia:**

| Rango Distancia | Count | WR Teórico | TP_FIRST % | MFE/MAE Ratio | Good Entries % | Avg R:R | Conclusión |
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 476 | 35.7% | 56.3% | 4.04 | 44.3% | 2.03 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 257 | 48.2% | 49.8% | 1.71 | 45.9% | 1.95 | ❌ BAJA CALIDAD - Filtro correcto |
| 3.0-5.0 ATR (Media) | 373 | 67.0% | 55.8% | 2.76 | 60.3% | 2.10 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 200 | 70.5% | 63.5% | 0.96 | 67.5% | 2.40 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 14 | 50.0% | 35.7% | 0.13 | 35.7% | 3.36 | ❌ BAJA CALIDAD - Filtro correcto |

**📈 Análisis Detallado por Rango:**

**0.0-2.0 ATR (Muy cerca)** (476 oportunidades)

- **WR Teórico:** 35.7% (si se hubieran ejecutado)
- **TP_FIRST:** 56.3% (268 de 476)
- **SL_FIRST:** 40.8% (194 de 476)
- **MFE Promedio:** 46.71 pts
- **MAE Promedio:** 38.56 pts
- **MFE/MAE Ratio:** 4.04
- **Good Entries:** 44.3% (MFE > MAE)
- **R:R Promedio:** 2.03
...
- **WR Teórico:** 48.2% (si se hubieran ejecutado)
- **TP_FIRST:** 49.8% (128 de 257)
- **SL_FIRST:** 50.2% (129 de 257)
- **MFE Promedio:** 53.40 pts
- **MAE Promedio:** 42.34 pts
- **MFE/MAE Ratio:** 1.71
...
**3.0-5.0 ATR (Media)** (373 oportunidades)

- **WR Teórico:** 67.0% (si se hubieran ejecutado)
- **TP_FIRST:** 55.8% (208 de 373)
- **SL_FIRST:** 44.0% (164 de 373)
- **MFE Promedio:** 67.00 pts
- **MAE Promedio:** 42.26 pts
- **MFE/MAE Ratio:** 2.76
- **Good Entries:** 60.3% (MFE > MAE)
- **R:R Promedio:** 2.10
...
- **WR Teórico:** 70.5% (si se hubieran ejecutado)
- **TP_FIRST:** 63.5% (127 de 200)
- **SL_FIRST:** 36.5% (73 de 200)
- **MFE Promedio:** 77.15 pts
- **MAE Promedio:** 48.32 pts
- **MFE/MAE Ratio:** 0.96
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 43 | 476 | 257 | 373 |
| **TP_FIRST %** | 55.8% | 56.3% | 49.8% | 55.8% |
| **Good Entries %** | 48.8% | 44.3% | 45.9% | 60.3% |
| **MFE/MAE Ratio** | 52.05 | 4.04 | 1.71 | 2.76 |

**💡 RECOMENDACIONES BASADAS EN DATOS:**

⚠️ **ATENCIÓN: El rango 3.0-5.0 ATR contiene 373 oportunidades con calidad MEDIA-ALTA**
   - WR Teórico: 67.0%
   - Good Entries: 60.3%
...
**Gap:** 0.10 (necesitas mejorar R:R)
...
**Problema:** R:R actual (2.21) < R:R mínimo (2.31)
