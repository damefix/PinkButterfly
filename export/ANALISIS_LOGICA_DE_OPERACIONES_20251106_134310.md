...
**Fecha:** 2025-11-06 15:47:00
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251106_134310.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251106_134310.csv`
...
- **Operaciones Ejecutadas:** 87
- **Win Rate:** 0.0% (0/87)
- **Profit Factor:** 0.78
- **Avg R:R Planeado:** 43.98
...
2. **LÍMITES SL/TP NO CALIBRADOS PARA INTRADÍA:**
   ...
   - TP máximo observado: 100 puntos
...
```csharp
// En EngineConfig.cs
public int MaxSLDistancePoints { get; set; } = 89; // Era 60
public int MaxTPDistancePoints { get; set; } = 87; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 89.6pts, TP: 87.6pts)
...
**Estado actual:** R:R promedio = 43.98
**Gap:** -42.23 (necesitas mejorar R:R)
...
**Solución:**
1. **MaxSLDistancePoints:** 60 → **89** (P90 real)
...
**Problema:** R:R actual (43.98) < R:R mínimo (1.75)
