# Informe Diagnóstico de Logs - 2025-11-05 09:02:05

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251105_085735.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251105_085735.csv`

## DFM
- Eventos de evaluación: 1734
- Evaluaciones Bull: 2982 | Bear: 239
- Pasaron umbral (PassedThreshold): 1900
- ConfidenceBins acumulado: 0:0, 1:0, 2:0, 3:12, 4:107, 5:609, 6:1214, 7:1271, 8:8, 9:0
...
## Proximity
- Eventos: 3943
- KeptAligned: 8967/10030 | KeptCounter: 1790/3012
- Promedios reportados (media de promedios por evento):
  - AvgProxAligned≈ 0.513 | AvgProxCounter≈ 0.138
  - AvgDistATRAligned≈ 2.90 | AvgDistATRCounter≈ 0.64
- PreferAligned eventos: 3188 | Filtradas contra-bias: 876

### Proximity (Pre-PreferAligned)
- Eventos: 3943
- Aligned pre: 8967/10757 | Counter pre: 1790/10757
- AvgProxAligned(pre)≈ 0.513 | AvgDistATRAligned(pre)≈ 2.90

### Proximity Drivers
- Eventos: 3943
- Alineadas: n=8967 | BaseProx≈ 0.666 | ZoneATR≈ 4.70 | SizePenalty≈ 0.982 | FinalProx≈ 0.655
- Contra-bias: n=914 | BaseProx≈ 0.554 | ZoneATR≈ 4.60 | SizePenalty≈ 0.983 | FinalProx≈ 0.546

## Risk
- Eventos: 3627
- Accepted=3253 | RejSL=77 | RejTP=2035 | RejRR=0 | RejEntry=0
...
- Matched aceptaciones con CSV: 68 | Unmatched: 3185
...
- Muestras: 3253 | Aligned=3193 (98.2%)
- Core≈ 1.00 | Prox≈ 0.67 | ConfC≈ 0.00 | ConfScore≈ 0.00 | RR≈ 1.10 | Confidence≈ 0.00
- SL_TF dist: {'15': 509, '-1': 23, '5': 128, '240': 244, '60': 2311, '1440': 38} | SL_Structural≈ 99.3%
- TP_TF dist: {'-1': 2792, '5': 99, '240': 254, '60': 86, '1440': 19, '15': 3} | TP_Structural≈ 14.2%

### SLPick por Bandas y TF
- Bandas: lt8=2688, 8-10=321, 10-12.5=147, 12.5-15=97, >15=0
- TF: 5m=128, 15m=509, 60m=2311, 240m=244, 1440m=38
- RR plan por bandas: 0-10≈ 1.11 (n=3009), 10-15≈ 1.01 (n=244)
...
## StructureFusion
- Trazas por zona: 13042 | Zonas con Anchors: 12988
- Dir zonas (zona): Bull=7497 Bear=5545 Neutral=0
- Resumen por ciclo (promedios): TotHZ≈ 2.6, WithAnchors≈ 2.6, DirBull≈ 1.5, DirBear≈ 1.1, DirNeutral≈ 0.0
- Razones de dirección: {'triggers-only': 53, 'tie-bias': 565, 'anchors+triggers': 12424}
- TF Triggers: {'15': 4672, '5': 8370}
- TF Anchors: {'240': 12755, '60': 12872, '1440': 10150}
...
- DFM Señales (PassedThreshold): 1900
- Registered: 42
...
### Stop Loss (SL)
- Zonas analizadas: 9856 | Total candidatos: 250860 | Seleccionados: 9802
...
- **TF Candidatos**: {240: 85202, 60: 76118, 15: 41813, 1440: 24880, 5: 22847}
- **TF Seleccionados**: {15: 876, 5: 263, 240: 1357, 60: 6164, 1440: 1142}
- **DistATR** - Candidatos: avg=21.9 | Seleccionados: avg=9.9
- **Razones de selección**: {'Fallback<15': 2122, 'InBand[8,15]_TFPreference': 7680}
- **En banda [10,15] ATR**: 42429/250860 (16.9%)

### Take Profit (TP)
- Zonas analizadas: 9881 | Total candidatos: 136090 | Seleccionados: 9881
