...
**Fecha:** 2025-11-10 12:41:04
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_124014.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251110_124014.csv`
...
- **MFE Promedio:** 48.65 pts (máxima ganancia flotante)
- **MAE Promedio:** 18.44 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 327.73

**Dirección Inicial (primeras 3 barras @ 5m):**

| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 104 | 65.0% |
| SL_FIRST (precio fue hacia SL) | 52 | 32.5% |
| NEUTRAL (sin dirección clara) | 4 | 2.5% |

**Calidad de Entradas:**

- **Entradas Buenas (MFE > MAE):** 67.5%
- **Entradas Malas (MAE > MFE):** 32.5%
...
| PENDING | 138 | 90 | 44 | 65.2% | 47.73 | 18.51 |
...
**Problema:** R:R actual (1.82) < R:R mínimo (1.75)
