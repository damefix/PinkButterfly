# Informe Diagnóstico de Logs - 2025-11-18 10:09:12
...
- Matched aceptaciones con CSV: 21 | Unmatched: 342
...
- Muestras: 363 | Aligned=163 (44.9%)
- Core≈ 1.00 | Prox≈ 0.62 | ConfC≈ 0.00 | ConfScore≈ 0.00 | RR≈ 2.31 | Confidence≈ 0.00
- SL_TF dist: {'15': 253, '60': 29, '5': 58, '240': 23} | SL_Structural≈ 100.0%
- TP_TF dist: {'5': 96, '240': 103, '60': 36, '15': 128} | TP_Structural≈ 100.0%
...
- Expiraciones: {'estructura no existe': 11, 'score decayó a 0,22': 1, 'score decayó a 0,24': 1}
- Cancel_BOS (diag): por acción {'BUY': 0, 'SELL': 1} | por bias {'Bullish': 1, 'Bearish': 0, 'Neutral': 0}

## CSV de Trades
- Filas: 61 | Ejecutadas: 12 | Canceladas: 0 | Expiradas: 0
- BUY: 7 | SELL: 66

## 📊 Embudo de Señales (Funnel)
- DFM Señales (PassedThreshold): 229
- Registered: 33
  - DEDUP_COOLDOWN: 10 | DEDUP_IDENTICAL: 0 | SKIP_CONCURRENCY: 40
- Intentos de registro: 83

### Ratios del Funnel
- Coverage = Intentos / PassedThreshold = 36.2%
- RegRate = Registered / Intentos = 39.8%
- Dedup Rate = (COOLDOWN+IDENTICAL) / Intentos = 12.0%
- Concurrency = SKIP_CONCURRENCY / Intentos = 48.2%
