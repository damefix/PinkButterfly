...
**Fecha:** 2025-11-11 17:12:21
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251111_170530.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251111_170530.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 39678 | 100.0% | 100.0% |
| ProximityAnalyzer | 5 | 0.0% | 0.0% |
| DFM_Evaluated | 31 | 620.0% | 0.1% |
| DFM_Passed | 0 | 0.0% | 0.0% |
| RiskCalculator | 0 | 0.0% | 0.0% |
| TradeManager | 8 | 0.0% | 0.0% |

**Análisis:**
- **Mayor caída:** DFM_Passed (pierde 31 señales, -100.0%)
- **Tasa de conversión final:** 0.02% (de 39678 zonas iniciales → 8 operaciones)
...
- **MFE Promedio:** 59.03 pts (máxima ganancia flotante)
- **MAE Promedio:** 42.19 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 2.39
...
| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 4 | 50.0% |
| SL_FIRST (precio fue hacia SL) | 4 | 50.0% |
...
| T0003 | SELL | 19.50 | 52.75 | 0.37 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0004 | BUY | 9.50 | 85.00 | 0.11 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
...
**Rationale:** Basado en percentil 90 de operaciones reales (SL: 25.9pts, TP: 49.9pts)
...
**Problema:** R:R actual (2.02) < R:R mínimo (1.75)
