# Informe Diagnóstico de Logs - 2025-11-19 20:57:11
...
## Proximity
- Eventos: 3124
- KeptAligned: 3256/3256 | KeptCounter: 2741/2972
- Promedios reportados (media de promedios por evento):
  - AvgProxAligned≈ 0.203 | AvgProxCounter≈ 0.140
  - AvgDistATRAligned≈ 0.88 | AvgDistATRCounter≈ 0.81
- PreferAligned eventos: 884 | Filtradas contra-bias: 10

### Proximity (Pre-PreferAligned)
- Eventos: 3124
- Aligned pre: 3256/5997 | Counter pre: 2741/5997
- AvgProxAligned(pre)≈ 0.203 | AvgDistATRAligned(pre)≈ 0.88

### Proximity Drivers
- Eventos: 3124
- Alineadas: n=3256 | BaseProx≈ 0.714 | ZoneATR≈ 4.31 | SizePenalty≈ 0.986 | FinalProx≈ 0.704
- Contra-bias: n=2731 | BaseProx≈ 0.478 | ZoneATR≈ 5.34 | SizePenalty≈ 0.974 | FinalProx≈ 0.466

## Risk
- Eventos: 1822
- Accepted=928 | RejSL=0 | RejTP=0 | RejRR=1482 | RejEntry=0
### TP P0 HeatZone-Based (V6.0f-FASE2)
- **P0_ANY_DIR:** 843 (19.2% del total)
  - Avg Score: 0.38 | Avg R:R: 1.91 | Avg DistATR: 3.79
  - Por TF: TF5=114, TF15=729
- **P0_SWING_LITE:** 3541 (80.8% del total)
  - Avg Score: 0.63 | Avg R:R: 3.43 | Avg DistATR: 3.75
  - Por TF: TF15=485, TF60=3056
...
## StructureFusion
- Trazas por zona: 24651 | Zonas con Anchors: 24651
- Dir zonas (zona): Bull=106 Bear=24445 Neutral=100
- Resumen por ciclo (promedios): TotHZ≈ 7.9, WithAnchors≈ 7.9, DirBull≈ 0.0, DirBear≈ 7.8, DirNeutral≈ 0.0
- Razones de dirección: {'anchors+triggers': 24546, 'tie-bias': 105}
- TF Triggers: {'5': 11988, '15': 12663}
- TF Anchors: {'60': 24651, '240': 24651, '1440': 24651}
...
### Stop Loss (SL)
- Zonas analizadas: 5657 | Total candidatos: 89397 | Seleccionados: 128
- Candidatos por zona (promedio): 15.8

### Take Profit (TP)
- Zonas analizadas: 5657 | Total candidatos: 138171 | Seleccionados: 5657
...
- **Priority Candidatos**: {'P3': 73022}
- **Priority Seleccionados**: {'P3': 4212, 'NA': 1037, 'P0': 408}
- **Type Candidatos**: {'Swing': 73022}
- **Type Seleccionados**: {'P3_Swing': 4212, 'P4_Fallback': 1037, 'P0_Zone': 408}
- **TF Candidatos**: {240: 48951, 60: 11019, 15: 7255, 5: 5797}
- **TF Seleccionados**: {240: 1939, -1: 1037, 15: 1086, 60: 1050, 5: 545}
- **DistATR** - Candidatos: avg=17.9 | Seleccionados: avg=5.9
- **RR** - Candidatos: avg=6.68 | Seleccionados: avg=1.57
- **Razones de selección**: {'BestIntelligentScore': 5657}
