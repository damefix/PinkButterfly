...
**Fecha:** 2025-11-06 21:11:48
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251106_210503.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251106_210503.csv`
...
```csharp
// En EngineConfig.cs
public int MaxSLDistancePoints { get; set; } = 76; // Era 60
public int MaxTPDistancePoints { get; set; } = 71; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 76.4pts, TP: 71.2pts)
...
**Estado actual:** R:R promedio = 66.63
**Gap:** -64.88 (necesitas mejorar R:R)
...
**Solución:**
1. **MaxSLDistancePoints:** 60 → **76** (P90 real)
2. **MaxTPDistancePoints:** 120 → **71** (P90 real)
...
**Problema:** R:R actual (66.63) < R:R mínimo (1.75)
