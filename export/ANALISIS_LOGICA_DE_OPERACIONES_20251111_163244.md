...
**Fecha:** 2025-11-11 16:37:13
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251111_163244.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251111_163244.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 39551 | 100.0% | 100.0% |
| ProximityAnalyzer | 5 | 0.0% | 0.0% |
| DFM_Evaluated | 30 | 600.0% | 0.1% |
| DFM_Passed | 0 | 0.0% | 0.0% |
| RiskCalculator | 0 | 0.0% | 0.0% |
| TradeManager | 8 | 0.0% | 0.0% |

**Análisis:**
- **Mayor caída:** DFM_Passed (pierde 30 señales, -100.0%)
- **Tasa de conversión final:** 0.02% (de 39551 zonas iniciales → 8 operaciones)
...
- **MFE Promedio:** 41.41 pts (máxima ganancia flotante)
- **MAE Promedio:** 51.84 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 1.76
...
- **Entradas Buenas (MFE > MAE):** 37.5%
- **Entradas Malas (MAE > MFE):** 62.5%
...
| T0004 | SELL | 0.25 | 85.75 | 0.00 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0007 | BUY | 22.25 | 47.50 | 0.47 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0008 | SELL | 53.50 | 21.50 | 2.49 | SL_FIRST | CLOSED | ✅ Entrada excelente |
| T0010 | SELL | 85.00 | 15.00 | 5.67 | SL_FIRST | CLOSED | ✅ Entrada excelente |
| T0012 | SELL | 7.50 | 60.25 | 0.12 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
...
**Rationale:** Basado en percentil 90 de operaciones reales (SL: 34.9pts, TP: 49.5pts)
