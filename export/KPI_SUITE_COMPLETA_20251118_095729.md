...
**Fecha:** 2025-11-18 10:00:25  
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251118_095729.csv`  
**Trades Analizados:** 0
...
**Análisis de 159 evaluaciones de HeatZones**

### Contribuciones Promedio por Componente

| Componente | Contribución Promedio | % del Total |
|------------|----------------------|-------------|
| **CoreScore** | 0.2000 | 26.7% |
| **Proximity** | 0.2420 | 32.3% |
| **Confluence** | 0.0600 | 8.0% |
| **Type** | 0.0133 | 1.8% |
| **Bias** | 0.2027 | 27.1% |
| **Momentum** | 0.0360 | 4.8% |
| **TOTAL (Avg Confidence)** | 0.7487 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 159
- **Señales generadas:** 159 (100.0%)
