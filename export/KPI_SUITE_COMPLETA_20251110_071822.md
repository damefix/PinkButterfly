...
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251110_071822.csv`  
**Trades Analizados:** 1
...
**Análisis de 39 evaluaciones de HeatZones**
...
| **Confluence** | 0.1500 | 19.6% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.1335 | 17.4% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.7673 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 39
- **Señales generadas:** 39 (100.0%)
