...
|------|---------------|---------------|------------|
| StructureFusion | 4374 | 100.0% | 100.0% |
| ProximityAnalyzer | 1056 | 24.1% | 24.1% |
| DFM_Evaluated | 177 | 16.8% | 4.0% |
| DFM_Passed | 177 | 100.0% | 4.0% |
| RiskCalculator | 1539 | 869.5% | 35.2% |
| Risk_Accepted | 16 | 1.0% | 0.4% |
| TradeManager | 2 | 12.5% | 0.0% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 1523 señales, -99.0%)
- **Tasa de conversión final:** 0.05% (de 4374 zonas iniciales → 2 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 314 | 53.0% |
| ENTRY_TOO_FAR | 216 | 36.4% |
| TP_CHECK_FAIL | 42 | 7.1% |
| NO_SL | 21 | 3.5% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (314 rechazos, 53.0%)
...
**Total de Phantom Opportunities analizadas:** 213
...
| 3.0-5.0 ATR (Media) | 67 | 71.6% | 80.6% | 4.78 | 76.1% | 2.59 | ✅ BUENA CALIDAD - Considerar incluir |
...
**3.0-5.0 ATR (Media)** (67 oportunidades)

- **WR Teórico:** 71.6% (si se hubieran ejecutado)
- **TP_FIRST:** 80.6% (54 de 67)
- **SL_FIRST:** 19.4% (13 de 67)
- **MFE Promedio:** 106.44 pts
- **MAE Promedio:** 50.49 pts
- **MFE/MAE Ratio:** 4.78
- **Good Entries:** 76.1% (MFE > MAE)
- **R:R Promedio:** 2.59
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 2 | 83 | 34 | 67 |
| **TP_FIRST %** | 50.0% | 54.2% | 79.4% | 80.6% |
| **Good Entries %** | 50.0% | 60.2% | 76.5% | 76.1% |
...
⚠️ **ATENCIÓN: El rango 3.0-5.0 ATR contiene 67 oportunidades con calidad MEDIA-ALTA**
   - WR Teórico: 71.6%
   - Good Entries: 76.1%
