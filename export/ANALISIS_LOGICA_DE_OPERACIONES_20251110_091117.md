...
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_091117.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251110_091117.csv`
...
- **MFE Promedio:** 77.16 pts (máxima ganancia flotante)
- **MAE Promedio:** 5.44 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 700.51

**Dirección Inicial (primeras 3 barras @ 5m):**

| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 37 | 86.0% |
| SL_FIRST (precio fue hacia SL) | 6 | 14.0% |
| NEUTRAL (sin dirección clara) | 0 | 0.0% |

**Calidad de Entradas:**

- **Entradas Buenas (MFE > MAE):** 93.0%
- **Entradas Malas (MAE > MFE):** 7.0%
...
| PENDING | 22 | 18 | 4 | 81.8% | 81.32 | 3.60 |
| EXPIRED | 20 | 18 | 2 | 90.0% | 70.01 | 7.72 |
...
- 20 señales expiradas tienen 90.0% TP_FIRST
...
public int MaxTPDistancePoints { get; set; } = 102; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 49.5pts, TP: 103.0pts)
...
**Estado actual:** R:R promedio = 1.52
**Gap:** 0.23 (necesitas mejorar R:R)
...
2. **MaxTPDistancePoints:** 120 → **102** (P90 real)
...
**Problema:** R:R actual (1.52) < R:R mínimo (1.75)
