# Informe Diagnóstico de Logs - 2025-11-21 10:20:36

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251121_101321.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251121_101321.csv`
...
- **P0_SWING_LITE:** 2207 (69.3% del total)
  - Avg Score: 0.82 | Avg R:R: 2.96 | Avg DistATR: 4.07
  - Por TF: TF15=262, TF60=1945
...
## StructureFusion
- Trazas por zona: 50646 | Zonas con Anchors: 50646
- Dir zonas (zona): Bull=3533 Bear=46443 Neutral=670
- Resumen por ciclo (promedios): TotHZ≈ 16.2, WithAnchors≈ 16.2, DirBull≈ 1.1, DirBear≈ 14.9, DirNeutral≈ 0.2
- Razones de dirección: {'anchors+triggers': 49644, 'tie-bias': 1002}
- TF Triggers: {'5': 32071, '15': 18575}
- TF Anchors: {'1440': 50646, '240': 50646, '60': 50646}
...
### Take Profit (TP)
- Zonas analizadas: 8040 | Total candidatos: 326824 | Seleccionados: 8040
- Candidatos por zona (promedio): 40.6
- **Edad (barras)** - Candidatos: med=1068, max=8001 | Seleccionados: med=0, max=0
- **Score** - Candidatos: avg=0.80 | Seleccionados: avg=0.66
- **Priority Candidatos**: {'P3': 185980}
- **Priority Seleccionados**: {'P3': 7287, 'NA': 522, 'P0': 231}
- **Type Candidatos**: {'Swing': 185980}
- **Type Seleccionados**: {'P3_Swing': 7287, 'P4_Fallback': 522, 'P0_Zone': 231}
- **TF Candidatos**: {5: 89362, 15: 52975, 240: 24013, 60: 19630}
- **TF Seleccionados**: {5: 4941, 240: 1744, 15: 607, -1: 522, 60: 226}
