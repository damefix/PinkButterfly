...
**Fecha:** 2025-11-06 20:28:01
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251106_202130.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251106_202130.csv`
...
- **Operaciones Ejecutadas:** 111
- **Win Rate:** 0.0% (0/111)
- **Profit Factor:** 1.23
- **Avg R:R Planeado:** 47.05
...
| ProximityAnalyzer | 18440 | 0.0% |
| DFM | 0 | 0.0% |
| RiskCalculator | 0 | 0.0% |
| TradeManager | 111 | 0.0% |
...
```csharp
// En EngineConfig.cs
public int MaxSLDistancePoints { get; set; } = 85; // Era 60
public int MaxTPDistancePoints { get; set; } = 84; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 85.3pts, TP: 84.5pts)
...
**Estado actual:** R:R promedio = 47.05
**Gap:** -45.30 (necesitas mejorar R:R)
...
**Solución:**
1. **MaxSLDistancePoints:** 60 → **85** (P90 real)
2. **MaxTPDistancePoints:** 120 → **84** (P90 real)
...
**Problema:** R:R actual (47.05) < R:R mínimo (1.75)
