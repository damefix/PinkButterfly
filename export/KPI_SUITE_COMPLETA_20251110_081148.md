...
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251110_081148.csv`  
**Trades Analizados:** 2
...
| Trade ID | Dir | Entry | SL | TP | R:R Plan | Entry Date | Razón |
|----------|-----|-------|----|----|----------|------------|-------|
| T0001 | SELL | 6764.00 | 6772.80 | 6748.50 | 1.76 | 2025-11-07 10:45:00 | score decayó a 0 |
...
**Análisis de 52 evaluaciones de HeatZones**

### Contribuciones Promedio por Componente

| Componente | Contribución Promedio | % del Total |
|------------|----------------------|-------------|
| **CoreScore** | 0.2500 | 33.4% |
| **Proximity** | 0.2645 | 35.4% |
| **Confluence** | 0.1500 | 20.1% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.1335 | 17.9% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.7476 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 52
- **Señales generadas:** 52 (100.0%)
