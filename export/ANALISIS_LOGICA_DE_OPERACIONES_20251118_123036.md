...
**Fecha:** 2025-11-18 12:35:08
**LOG:** `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251118_123036.log`
**CSV:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251118_123036.csv`
...
- **R:R Mínimo para Break-Even:** 1.30
...
|------|---------------|---------------|------------|
| StructureFusion | 12318 | 100.0% | 100.0% |
| ProximityAnalyzer | 2836 | 23.0% | 23.0% |
| DFM_Evaluated | 482 | 17.0% | 3.9% |
| DFM_Passed | 482 | 100.0% | 3.9% |
| RiskCalculator | 5476 | 1136.1% | 44.5% |
| Risk_Accepted | 68 | 1.2% | 0.6% |
| TradeManager | 23 | 33.8% | 0.2% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 5408 señales, -98.8%)
- **Tasa de conversión final:** 0.19% (de 12318 zonas iniciales → 23 operaciones)
...
- **MFE Promedio:** 35.63 pts (máxima ganancia flotante)
- **MAE Promedio:** 28.28 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 138.69

**Dirección Inicial (primeras 3 barras @ 5m):**

| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 15 | 65.2% |
| SL_FIRST (precio fue hacia SL) | 8 | 34.8% |
| NEUTRAL (sin dirección clara) | 0 | 0.0% |

**Calidad de Entradas:**

- **Entradas Buenas (MFE > MAE):** 52.2%
- **Entradas Malas (MAE > MFE):** 47.8%

**🔍 Análisis por Estado (Modo Diagnóstico):**

| Estado | Count | TP_FIRST | SL_FIRST | TP_FIRST % | MFE Avg | MAE Avg |
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 23 | 15 | 8 | 65.2% | 35.63 | 28.28 |
...
| T0042 | SELL | 37.75 | 64.75 | 0.58 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0042_2 | SELL | 37.75 | 64.75 | 0.58 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0042_3 | SELL | 37.75 | 64.75 | 0.58 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0045 | SELL | 16.50 | 32.75 | 0.50 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
| T0047 | BUY | 16.00 | 10.75 | 1.49 | TP_FIRST | CLOSED | 👍 Entrada correcta |
| T0048 | SELL | 21.00 | 11.25 | 1.87 | TP_FIRST | CLOSED | ✅ Entrada excelente |
| T0054 | SELL | 41.75 | 10.50 | 3.98 | SL_FIRST | CLOSED | ✅ Entrada excelente |
| T0059 | SELL | 0.00 | 103.25 | 0.00 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0059_2 | SELL | 0.00 | 103.25 | 0.00 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0063 | SELL | 17.75 | 34.25 | 0.52 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
...
**Total de Phantom Opportunities analizadas:** 760
...
| 3.0-5.0 ATR (Media) | 220 | 71.8% | 65.9% | 4.41 | 69.5% | 2.43 | ✅ BUENA CALIDAD - Considerar incluir |
...
- **WR Teórico:** 71.8% (si se hubieran ejecutado)
- **TP_FIRST:** 65.9% (145 de 220)
- **SL_FIRST:** 34.1% (75 de 220)
- **MFE Promedio:** 86.32 pts
- **MAE Promedio:** 43.30 pts
- **MFE/MAE Ratio:** 4.41
- **Good Entries:** 69.5% (MFE > MAE)
- **R:R Promedio:** 2.43
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 23 | 282 | 136 | 220 |
| **TP_FIRST %** | 65.2% | 52.5% | 60.3% | 65.9% |
| **Good Entries %** | 52.2% | 52.1% | 56.6% | 69.5% |
| **MFE/MAE Ratio** | 138.69 | 5.09 | 3.10 | 4.41 |

**💡 RECOMENDACIONES BASADAS EN DATOS:**

⚠️ **ATENCIÓN: El rango 3.0-5.0 ATR contiene 220 oportunidades con calidad MEDIA-ALTA**
   - WR Teórico: 71.8%
   - Good Entries: 69.5%
...
**Rationale:** Basado en percentil 90 de operaciones reales (SL: 24.5pts, TP: 50.1pts)

### 4.4 R:R Óptimo

**Para Win Rate actual (43.5%), el R:R mínimo es:**

```
R:R_min = (1 - WR) / WR
R:R_min = (1 - 0.435) / 0.435
R:R_min = 1.30
```

**Estado actual:** R:R promedio = 2.21
**Gap:** -0.91 (necesitas mejorar R:R)
...
**Problema:** R:R actual (2.21) < R:R mínimo (1.30)
...
**Impacto esperado:** Sistema break-even con WR=43.5%
