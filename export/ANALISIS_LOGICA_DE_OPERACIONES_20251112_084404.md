...
**Fecha:** 2025-11-12 08:58:23
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251112_084404.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251112_084404.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 18484 | 100.0% | 100.0% |
| ProximityAnalyzer | 6 | 0.0% | 0.0% |
| DFM_Evaluated | 197 | 3283.3% | 1.1% |
| DFM_Passed | 177 | 89.8% | 1.0% |
| RiskCalculator | 46 | 26.0% | 0.2% |
| TradeManager | 33 | 71.7% | 0.2% |

**Análisis:**
- **Mayor caída:** ProximityAnalyzer (pierde 18478 señales, -100.0%)
- **Tasa de conversión final:** 0.18% (de 18484 zonas iniciales → 33 operaciones)

### 3.2 Distribución por Tipo de TP

| Tipo TP | Count | % |
|---------|-------|---|
| P0_SWING_LITE | 396 | 93.2% |
| P0_ANY_DIR | 29 | 6.8% |
...
- **MFE Promedio:** 29.73 pts (máxima ganancia flotante)
- **MAE Promedio:** 42.63 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 1.43
...
| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 10 | 30.3% |
| SL_FIRST (precio fue hacia SL) | 22 | 66.7% |
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 33 | 10 | 22 | 30.3% | 29.73 | 42.63 |
...
| T0012 | SELL | 29.00 | 31.75 | 0.91 | SL_FIRST | CLOSED | ⚠️ Entrada dudosa |
| T0013 | BUY | 9.50 | 85.00 | 0.11 | SL_FIRST | CLOSED | ❌ Entrada muy mala |
| T0017 | BUY | 14.75 | 16.25 | 0.91 | SL_FIRST | CLOSED | ⚠️ Entrada dudosa |
...
**Gap:** 1.37 (necesitas mejorar R:R)
...
**Problema:** R:R actual (1.76) < R:R mínimo (3.12)
