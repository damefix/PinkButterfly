...
|------|---------------|---------------|------------|
| StructureFusion | 66605 | 100.0% | 100.0% |
| ProximityAnalyzer | 1211 | 1.8% | 1.8% |
| DFM_Evaluated | 174 | 14.4% | 0.3% |
| DFM_Passed | 174 | 100.0% | 0.3% |
| RiskCalculator | 2322 | 1334.5% | 3.5% |
| Risk_Accepted | 9 | 0.4% | 0.0% |
| TradeManager | 1 | 11.1% | 0.0% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 2313 señales, -99.6%)
- **Tasa de conversión final:** 0.00% (de 66605 zonas iniciales → 1 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 922 | 61.9% |
| ENTRY_TOO_FAR | 394 | 26.5% |
| TP_CHECK_FAIL | 145 | 9.7% |
| NO_SL | 28 | 1.9% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (922 rechazos, 61.9%)
...
**Total de Phantom Opportunities analizadas:** 241

**Calidad por Rango de Distancia:**

| Rango Distancia | Count | WR Teórico | TP_FIRST % | MFE/MAE Ratio | Good Entries % | Avg R:R | Conclusión |
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 82 | 12.2% | 28.0% | 1.08 | 45.1% | 3.11 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 52 | 30.8% | 38.5% | 0.87 | 50.0% | 3.54 | ❌ BAJA CALIDAD - Filtro correcto |
...
**0.0-2.0 ATR (Muy cerca)** (82 oportunidades)

- **WR Teórico:** 12.2% (si se hubieran ejecutado)
- **TP_FIRST:** 28.0% (23 de 82)
- **SL_FIRST:** 69.5% (57 de 82)
...
**2.0-3.0 ATR (Cerca)** (52 oportunidades)

- **WR Teórico:** 30.8% (si se hubieran ejecutado)
- **TP_FIRST:** 38.5% (20 de 52)
- **SL_FIRST:** 55.8% (29 de 52)
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 1 | 82 | 52 | 63 |
| **TP_FIRST %** | 100.0% | 28.0% | 38.5% | 47.6% |
| **Good Entries %** | 100.0% | 45.1% | 50.0% | 36.5% |
