...
**Fecha:** 2025-11-11 10:43:06  
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251111_103713.csv`  
**Trades Analizados:** 0
...
**Análisis de 210 evaluaciones de HeatZones**
...
| **Proximity** | 0.1332 | 22.7% |
| **Confluence** | 0.0000 | 0.0% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.1732 | 29.5% |
| **Momentum** | 0.0600 | 10.2% |
| **TOTAL (Avg Confidence)** | 0.5866 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 210
- **Señales generadas:** 0 (0.0%)
- **Señales rechazadas (WAIT):** 210 (100.0%)
