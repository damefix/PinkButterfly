...
**Fecha:** 2025-11-13 09:43:37
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251113_094059.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251113_094059.csv`
...
| ProximityAnalyzer | 4148 | 40.2% | 40.2% |
| DFM_Evaluated | 842 | 20.3% | 8.2% |
| DFM_Passed | 842 | 100.0% | 8.2% |
| RiskCalculator | 6317 | 750.2% | 61.2% |
| Risk_Accepted | 102 | 1.6% | 1.0% |
| TradeManager | 35 | 34.3% | 0.3% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6215 señales, -98.4%)
- **Tasa de conversión final:** 0.34% (de 10315 zonas iniciales → 35 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,660 | 58.8% |
| NO_SL | 512 | 18.1% |
| ENTRY_TOO_FAR | 387 | 13.7% |
| TP_CHECK_FAIL | 262 | 9.3% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,660 rechazos, 58.8%)
...
- **MFE Promedio:** 44.94 pts (máxima ganancia flotante)
- **MAE Promedio:** 29.64 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 63.52
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 35 | 24 | 10 | 68.6% | 44.94 | 29.64 |
...
**Total de Phantom Opportunities analizadas:** 1,307

**Calidad por Rango de Distancia:**

| Rango Distancia | Count | WR Teórico | TP_FIRST % | MFE/MAE Ratio | Good Entries % | Avg R:R | Conclusión |
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 478 | 37.4% | 60.5% | 4.04 | 45.6% | 2.02 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 250 | 50.0% | 52.0% | 1.62 | 46.8% | 1.91 | ❌ BAJA CALIDAD - Filtro correcto |
| 3.0-5.0 ATR (Media) | 365 | 69.3% | 57.5% | 2.90 | 60.5% | 2.07 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 200 | 69.5% | 64.5% | 0.91 | 67.5% | 2.34 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 14 | 50.0% | 35.7% | 0.13 | 35.7% | 3.14 | ❌ BAJA CALIDAD - Filtro correcto |
...
- **TP_FIRST:** 60.5% (289 de 478)
- **SL_FIRST:** 37.2% (178 de 478)
- **MFE Promedio:** 50.01 pts
- **MAE Promedio:** 39.31 pts
- **MFE/MAE Ratio:** 4.04
- **Good Entries:** 45.6% (MFE > MAE)
- **R:R Promedio:** 2.02

**❌ BAJA CALIDAD - Filtro correcto**

**2.0-3.0 ATR (Cerca)** (250 oportunidades)

- **WR Teórico:** 50.0% (si se hubieran ejecutado)
- **TP_FIRST:** 52.0% (130 de 250)
- **SL_FIRST:** 48.0% (120 de 250)
- **MFE Promedio:** 57.45 pts
- **MAE Promedio:** 42.60 pts
- **MFE/MAE Ratio:** 1.62
...
- **TP_FIRST:** 64.5% (129 de 200)
- **SL_FIRST:** 35.5% (71 de 200)
- **MFE Promedio:** 79.94 pts
- **MAE Promedio:** 49.47 pts
- **MFE/MAE Ratio:** 0.91
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 35 | 478 | 250 | 365 |
| **TP_FIRST %** | 68.6% | 60.5% | 52.0% | 57.5% |
| **Good Entries %** | 45.7% | 45.6% | 46.8% | 60.5% |
| **MFE/MAE Ratio** | 63.52 | 4.04 | 1.62 | 2.90 |
...
**Problema:** R:R actual (2.45) < R:R mínimo (2.18)
