...
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251109_212718.csv`  
**Trades Analizados:** 2
...
|----------|-----|-------|----|----|----------|------------|-------|
| T0001 | SELL | 6741.75 | 6774.48 | 6655.50 | 2.64 | 2025-11-07 20:00:00 | BOS contradictorio |
...
|------------|----------------------|-------------|
| **CoreScore** | 0.2500 | 31.0% |
| **Proximity** | 0.2738 | 33.9% |
| **Confluence** | 0.1500 | 18.6% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.1335 | 16.5% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.8073 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 29
- **Señales generadas:** 29 (100.0%)
...
- ⚠️ **CRÍTICO:** Ratio cancelaciones/cerradas muy alto (1/0 = 0.0x)
- **Problema:** El sistema está cancelando demasiadas operaciones
- **Análisis:** 50.0% de operaciones registradas son canceladas
