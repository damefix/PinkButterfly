# Informe Diagnóstico de Logs - 2025-11-17 16:51:30
...
## Proximity
- Eventos: 22104
- KeptAligned: 1233/1233 | KeptCounter: 1897/2037
- Promedios reportados (media de promedios por evento):
  - AvgProxAligned≈ 0.024 | AvgProxCounter≈ 0.025
  - AvgDistATRAligned≈ 0.10 | AvgDistATRCounter≈ 0.14
- PreferAligned eventos: 630 | Filtradas contra-bias: 538

### Proximity (Pre-PreferAligned)
- Eventos: 22104
- Aligned pre: 1233/3130 | Counter pre: 1897/3130
- AvgProxAligned(pre)≈ 0.024 | AvgDistATRAligned(pre)≈ 0.10

### Proximity Drivers
- Eventos: 22104
- Alineadas: n=1233 | BaseProx≈ 0.737 | ZoneATR≈ 6.65 | SizePenalty≈ 0.948 | FinalProx≈ 0.699
...
- TP_TF dist: {'15': 94, '60': 225, '5': 39, '240': 182} | TP_Structural≈ 100.0%
...
## StructureFusion
- Trazas por zona: 80194 | Zonas con Anchors: 80194
- Dir zonas (zona): Bull=17298 Bear=51651 Neutral=11245
- Resumen por ciclo (promedios): TotHZ≈ 3.4, WithAnchors≈ 3.4, DirBull≈ 0.7, DirBear≈ 2.2, DirNeutral≈ 0.5
- Razones de dirección: {'anchors+triggers': 67220, 'tie-bias': 12974}
- TF Triggers: {'5': 66807, '15': 13387}
- TF Anchors: {'60': 80194, '240': 80194, '1440': 80194}
...
- **TF Seleccionados**: {15: 463, -1: 276, 240: 901, 60: 507, 5: 169}
