...
**Fecha:** 2025-11-13 09:25:06
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251113_092053.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251113_092053.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 10329 | 100.0% | 100.0% |
| ProximityAnalyzer | 4152 | 40.2% | 40.2% |
| DFM_Evaluated | 845 | 20.4% | 8.2% |
| DFM_Passed | 845 | 100.0% | 8.2% |
| RiskCalculator | 6320 | 747.9% | 61.2% |
| Risk_Accepted | 100 | 1.6% | 1.0% |
| TradeManager | 35 | 35.0% | 0.3% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6220 señales, -98.4%)
- **Tasa de conversión final:** 0.34% (de 10329 zonas iniciales → 35 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,661 | 58.8% |
| NO_SL | 515 | 18.2% |
| ENTRY_TOO_FAR | 385 | 13.6% |
| TP_CHECK_FAIL | 262 | 9.3% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,661 rechazos, 58.8%)
...
- **MFE Promedio:** 44.13 pts (máxima ganancia flotante)
- **MAE Promedio:** 30.39 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 60.10
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 35 | 23 | 11 | 65.7% | 44.13 | 30.39 |
...
**Total de Phantom Opportunities analizadas:** 1,302

**Calidad por Rango de Distancia:**

| Rango Distancia | Count | WR Teórico | TP_FIRST % | MFE/MAE Ratio | Good Entries % | Avg R:R | Conclusión |
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 473 | 37.2% | 60.0% | 4.00 | 46.1% | 2.02 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 249 | 49.8% | 51.8% | 1.62 | 47.4% | 1.91 | ❌ BAJA CALIDAD - Filtro correcto |
| 3.0-5.0 ATR (Media) | 364 | 69.5% | 57.7% | 2.91 | 61.3% | 2.07 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 203 | 69.5% | 65.0% | 0.86 | 67.5% | 2.38 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 13 | 53.8% | 38.5% | 0.15 | 38.5% | 3.32 | ❌ BAJA CALIDAD - Filtro correcto |

**📈 Análisis Detallado por Rango:**

**0.0-2.0 ATR (Muy cerca)** (473 oportunidades)

- **WR Teórico:** 37.2% (si se hubieran ejecutado)
- **TP_FIRST:** 60.0% (284 de 473)
- **SL_FIRST:** 37.8% (179 de 473)
- **MFE Promedio:** 49.93 pts
- **MAE Promedio:** 39.37 pts
- **MFE/MAE Ratio:** 4.00
...
- **TP_FIRST:** 51.8% (129 de 249)
- **SL_FIRST:** 48.2% (120 de 249)
- **MFE Promedio:** 56.89 pts
- **MAE Promedio:** 42.52 pts
- **MFE/MAE Ratio:** 1.62
...
- **MFE Promedio:** 70.04 pts
- **MAE Promedio:** 42.55 pts
- **MFE/MAE Ratio:** 2.91
- **Good Entries:** 61.3% (MFE > MAE)
- **R:R Promedio:** 2.07
...
- **WR Teórico:** 69.5% (si se hubieran ejecutado)
- **TP_FIRST:** 65.0% (132 de 203)
- **SL_FIRST:** 35.0% (71 de 203)
- **MFE Promedio:** 80.15 pts
- **MAE Promedio:** 52.40 pts
- **MFE/MAE Ratio:** 0.86
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 35 | 473 | 249 | 364 |
| **TP_FIRST %** | 65.7% | 60.0% | 51.8% | 57.7% |
| **Good Entries %** | 45.7% | 46.1% | 47.4% | 61.3% |
| **MFE/MAE Ratio** | 60.10 | 4.00 | 1.62 | 2.91 |
...
**Gap:** -0.54 (necesitas mejorar R:R)
