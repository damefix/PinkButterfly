...
**Fecha:** 2025-11-13 15:57:49
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251113_155348.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251113_155348.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 10364 | 100.0% | 100.0% |
| ProximityAnalyzer | 4126 | 39.8% | 39.8% |
| DFM_Evaluated | 840 | 20.4% | 8.1% |
| DFM_Passed | 840 | 100.0% | 8.1% |
| RiskCalculator | 6379 | 759.4% | 61.5% |
| Risk_Accepted | 2 | 0.0% | 0.0% |
| TradeManager | 37 | 1850.0% | 0.4% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6377 señales, -100.0%)
- **Tasa de conversión final:** 0.36% (de 10364 zonas iniciales → 37 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,669 | 57.9% |
| NO_SL | 566 | 19.6% |
| ENTRY_TOO_FAR | 392 | 13.6% |
| TP_CHECK_FAIL | 257 | 8.9% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,669 rechazos, 57.9%)
...
- **MFE Promedio:** 44.68 pts (máxima ganancia flotante)
- **MAE Promedio:** 27.94 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 114.12
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 37 | 24 | 11 | 64.9% | 44.68 | 27.94 |
...
**Total de Phantom Opportunities analizadas:** 1,312

**Calidad por Rango de Distancia:**

| Rango Distancia | Count | WR Teórico | TP_FIRST % | MFE/MAE Ratio | Good Entries % | Avg R:R | Conclusión |
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 475 | 37.5% | 59.8% | 4.27 | 47.6% | 2.05 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 249 | 52.2% | 52.2% | 1.80 | 49.0% | 1.91 | ❌ BAJA CALIDAD - Filtro correcto |
| 3.0-5.0 ATR (Media) | 364 | 67.3% | 56.9% | 2.28 | 59.1% | 2.05 | ⚠️ CALIDAD MEDIA - Revisar |
| 5.0-10.0 ATR (Lejos) | 209 | 68.4% | 65.1% | 0.68 | 66.5% | 2.43 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 15 | 53.3% | 40.0% | 0.13 | 40.0% | 3.42 | ❌ BAJA CALIDAD - Filtro correcto |

**📈 Análisis Detallado por Rango:**

**0.0-2.0 ATR (Muy cerca)** (475 oportunidades)

- **WR Teórico:** 37.5% (si se hubieran ejecutado)
- **TP_FIRST:** 59.8% (284 de 475)
- **SL_FIRST:** 37.5% (178 de 475)
- **MFE Promedio:** 50.18 pts
- **MAE Promedio:** 42.01 pts
- **MFE/MAE Ratio:** 4.27
- **Good Entries:** 47.6% (MFE > MAE)
- **R:R Promedio:** 2.05
...
- **MFE Promedio:** 57.06 pts
- **MAE Promedio:** 44.91 pts
- **MFE/MAE Ratio:** 1.80
- **Good Entries:** 49.0% (MFE > MAE)
- **R:R Promedio:** 1.91
...
- **WR Teórico:** 67.3% (si se hubieran ejecutado)
- **TP_FIRST:** 56.9% (207 de 364)
- **SL_FIRST:** 43.1% (157 de 364)
- **MFE Promedio:** 72.00 pts
- **MAE Promedio:** 46.14 pts
- **MFE/MAE Ratio:** 2.28
...
- **TP_FIRST:** 65.1% (136 de 209)
- **SL_FIRST:** 34.0% (71 de 209)
- **MFE Promedio:** 80.44 pts
- **MAE Promedio:** 61.93 pts
- **MFE/MAE Ratio:** 0.68
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 37 | 475 | 249 | 364 |
| **TP_FIRST %** | 64.9% | 59.8% | 52.2% | 56.9% |
| **Good Entries %** | 54.1% | 47.6% | 49.0% | 59.1% |
| **MFE/MAE Ratio** | 114.12 | 4.27 | 1.80 | 2.28 |
...
**Gap:** -0.22 (necesitas mejorar R:R)
...
**Problema:** R:R actual (2.59) < R:R mínimo (2.36)
