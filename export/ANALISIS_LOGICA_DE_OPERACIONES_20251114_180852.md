...
**Fecha:** 2025-11-14 18:12:49
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251114_180852.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251114_180852.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 10493 | 100.0% | 100.0% |
| ProximityAnalyzer | 3681 | 35.1% | 35.1% |
| DFM_Evaluated | 862 | 23.4% | 8.2% |
| DFM_Passed | 862 | 100.0% | 8.2% |
| RiskCalculator | 6136 | 711.8% | 58.5% |
| Risk_Accepted | 1 | 0.0% | 0.0% |
| TradeManager | 49 | 4900.0% | 0.5% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6135 señales, -100.0%)
- **Tasa de conversión final:** 0.47% (de 10493 zonas iniciales → 49 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,365 | 51.3% |
| NO_SL | 661 | 24.8% |
| ENTRY_TOO_FAR | 408 | 15.3% |
| TP_CHECK_FAIL | 227 | 8.5% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,365 rechazos, 51.3%)
...
- **MAE Promedio:** 38.05 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 64.16
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 49 | 22 | 25 | 44.9% | 46.62 | 38.05 |
...
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 495 | 29.5% | 55.6% | 4.53 | 43.8% | 2.12 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 265 | 49.8% | 51.7% | 2.54 | 52.8% | 1.97 | ⚠️ CALIDAD MEDIA - Revisar |
| 3.0-5.0 ATR (Media) | 333 | 74.5% | 64.6% | 2.76 | 69.4% | 2.03 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 211 | 78.2% | 74.9% | 1.93 | 78.7% | 2.21 | ✅ BUENA CALIDAD - Considerar incluir |
...
- **TP_FIRST:** 55.6% (275 de 495)
- **SL_FIRST:** 41.0% (203 de 495)
- **MFE Promedio:** 49.19 pts
- **MAE Promedio:** 44.67 pts
- **MFE/MAE Ratio:** 4.53
...
**3.0-5.0 ATR (Media)** (333 oportunidades)

- **WR Teórico:** 74.5% (si se hubieran ejecutado)
- **TP_FIRST:** 64.6% (215 de 333)
- **SL_FIRST:** 35.4% (118 de 333)
- **MFE Promedio:** 92.53 pts
- **MAE Promedio:** 45.19 pts
- **MFE/MAE Ratio:** 2.76
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 49 | 495 | 265 | 333 |
| **TP_FIRST %** | 44.9% | 55.6% | 51.7% | 64.6% |
| **Good Entries %** | 42.9% | 43.8% | 52.8% | 69.4% |
| **MFE/MAE Ratio** | 64.16 | 4.53 | 2.54 | 2.76 |

**💡 RECOMENDACIONES BASADAS EN DATOS:**

⚠️ **ATENCIÓN: El rango 3.0-5.0 ATR contiene 333 oportunidades con calidad MEDIA-ALTA**
   - WR Teórico: 74.5%
   - Good Entries: 69.4%
