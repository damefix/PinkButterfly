...
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251107_212251.csv`  
**Trades Analizados:** 1
...
| Trade ID | Dir | Entry | SL | TP | R:R Plan | Entry Date | Razón |
|----------|-----|-------|----|----|----------|------------|-------|
| T0001 | SELL | 6756.75 | 6823.27 | 6687.25 | 1.04 | 2025-11-07 20:45:00 | STALE_DIST: 13 |
...
|------------|----------------------|-------------|
| **CoreScore** | 0.2500 | 27.9% |
| **Proximity** | 0.3972 | 44.3% |
| **Confluence** | 0.1500 | 16.7% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.1000 | 11.1% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.8972 | 100% |
