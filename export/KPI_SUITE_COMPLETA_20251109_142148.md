...
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251109_142148.csv`  
**Trades Analizados:** 1
...
|------------|----------------------|-------------|
| **CoreScore** | 0.2500 | 38.3% |
| **Proximity** | 0.3973 | 60.9% |
| **Confluence** | 0.1500 | 23.0% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.0509 | 7.8% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.6526 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 7
- **Señales generadas:** 4 (57.1%)
- **Señales rechazadas (WAIT):** 3 (42.9%)
