...
| DFM_Evaluated | 171 | 21.5% | 6.9% |
| DFM_Passed | 171 | 100.0% | 6.9% |
| RiskCalculator | 1414 | 826.9% | 56.9% |
| Risk_Accepted | 1 | 0.1% | 0.0% |
| TradeManager | 10 | 1000.0% | 0.4% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 1413 señales, -99.9%)
- **Tasa de conversión final:** 0.40% (de 2487 zonas iniciales → 10 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 506 | 65.5% |
| ENTRY_TOO_FAR | 165 | 21.3% |
| NO_SL | 89 | 11.5% |
| TP_CHECK_FAIL | 13 | 1.7% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (506 rechazos, 65.5%)
...
- **MFE Promedio:** 39.95 pts (máxima ganancia flotante)
- **MAE Promedio:** 19.95 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 201.26

**Dirección Inicial (primeras 3 barras @ 5m):**

| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 6 | 60.0% |
| SL_FIRST (precio fue hacia SL) | 4 | 40.0% |
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 10 | 6 | 4 | 60.0% | 39.95 | 19.95 |
...
| T0021_2 | SELL | 25.00 | 30.25 | 0.83 | TP_FIRST | CLOSED | ⚠️ Entrada dudosa |
...
**Total de Phantom Opportunities analizadas:** 272
...
| 5.0-10.0 ATR (Lejos) | 39 | 84.6% | 79.5% | 2.03 | 84.6% | 2.02 | ✅ BUENA CALIDAD - Considerar incluir |
...
**5.0-10.0 ATR (Lejos)** (39 oportunidades)

- **WR Teórico:** 84.6% (si se hubieran ejecutado)
- **TP_FIRST:** 79.5% (31 de 39)
- **SL_FIRST:** 20.5% (8 de 39)
- **MFE Promedio:** 103.81 pts
- **MAE Promedio:** 63.41 pts
- **MFE/MAE Ratio:** 2.03
- **Good Entries:** 84.6% (MFE > MAE)
- **R:R Promedio:** 2.02
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 10 | 97 | 40 | 95 |
| **TP_FIRST %** | 60.0% | 68.0% | 85.0% | 76.8% |
| **Good Entries %** | 50.0% | 54.6% | 72.5% | 82.1% |
| **MFE/MAE Ratio** | 201.26 | 5.05 | 4.95 | 7.85 |
...
**Rationale:** Basado en percentil 90 de operaciones reales (SL: 19.5pts, TP: 52.7pts)
...
**Estado actual:** R:R promedio = 2.68
**Gap:** -1.18 (necesitas mejorar R:R)
...
**Problema:** R:R actual (2.68) < R:R mínimo (1.50)
