...
**Fecha:** 2025-11-18 09:46:10
**LOG:** `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251118_094012.log`
**CSV:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251118_094012.csv`
...
2. **LÍMITES SL/TP NO CALIBRADOS PARA INTRADÍA:**
   - SL máximo observado: 4 puntos
   - TP máximo observado: 10 puntos
...
**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 4254 señales, -100.0%)
- **Tasa de conversión final:** 0.01% (de 11129 zonas iniciales → 1 operaciones)
...
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 315 | 0.0% | 0.0% | 0.00 | 0.0% | 2.56 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 155 | 0.0% | 0.0% | 0.00 | 0.0% | 2.34 | ❌ BAJA CALIDAD - Filtro correcto |
| 3.0-5.0 ATR (Media) | 297 | 0.0% | 0.0% | 0.00 | 0.0% | 2.41 | ❌ BAJA CALIDAD - Filtro correcto |
| 5.0-10.0 ATR (Lejos) | 131 | 0.0% | 0.0% | 0.00 | 0.0% | 2.08 | ❌ BAJA CALIDAD - Filtro correcto |
| >10.0 ATR (Muy lejos) | 47 | 0.0% | 0.0% | 0.00 | 0.0% | 2.97 | ❌ BAJA CALIDAD - Filtro correcto |
...
✅ **CORRECTO: El filtro 2.0 ATR está bloqueando 155 oportunidades de BAJA calidad**
   - WR Teórico: 0.0%
   - **ACCIÓN:** Mantener MaxDistanceToRegister_ATR_Normal = 2.0

✅ **CORRECTO: Las 297 oportunidades en 3.0-5.0 ATR tienen baja calidad**
...
**Gap:** -2.52 (necesitas mejorar R:R)
...
**Problema:** R:R actual (2.52) < R:R mínimo (0.00)
