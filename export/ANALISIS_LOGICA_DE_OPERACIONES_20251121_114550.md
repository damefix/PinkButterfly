...
|------|---------------|---------------|------------|
| StructureFusion | 51016 | 100.0% | 100.0% |
| ProximityAnalyzer | 4139 | 8.1% | 8.1% |
| DFM_Evaluated | 286 | 6.9% | 0.6% |
| DFM_Passed | 286 | 100.0% | 0.6% |
| RiskCalculator | 8453 | 2955.6% | 16.6% |
| Risk_Accepted | 12 | 0.1% | 0.0% |
| TradeManager | 7 | 58.3% | 0.0% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 8441 señales, -99.9%)
- **Tasa de conversión final:** 0.01% (de 51016 zonas iniciales → 7 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 5,087 | 73.2% |
| ENTRY_TOO_FAR | 1,384 | 19.9% |
| TP_CHECK_FAIL | 250 | 3.6% |
| NO_SL | 233 | 3.4% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (5,087 rechazos, 73.2%)
...
| Tipo TP | Count | % |
|---------|-------|---|
| P0_SWING_LITE | 2243 | 68.5% |
| P0_ANY_DIR | 1031 | 31.5% |
...
| 2.0-3.0 ATR (Cerca) | 74 | 85.1% | 74.3% | 7.55 | 85.1% | 2.26 | ✅ BUENA CALIDAD - Considerar incluir |
...
| **MFE/MAE Ratio** | 148.42 | 7.81 | 7.55 | 13.95 |
