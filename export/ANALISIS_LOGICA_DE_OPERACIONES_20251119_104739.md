...
- **Score Promedio:** -0.091
- **Score Min/Max:** [-0.950, 0.930]
- **Componentes (promedio):**
  - EMA20 Slope: -0.144
  - EMA50 Cross: -0.097
  - BOS Count: -0.055
  - Regression 24h: -0.051
...
|------|---------------|---------------|------------|
| StructureFusion | 4246 | 100.0% | 100.0% |
| ProximityAnalyzer | 1278 | 30.1% | 30.1% |
| DFM_Evaluated | 301 | 23.6% | 7.1% |
| DFM_Passed | 301 | 100.0% | 7.1% |
| RiskCalculator | 2138 | 710.3% | 50.4% |
| Risk_Accepted | 45 | 2.1% | 1.1% |
| TradeManager | 13 | 28.9% | 0.3% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 2093 señales, -97.9%)
- **Tasa de conversión final:** 0.31% (de 4246 zonas iniciales → 13 operaciones)
...
**Total de Phantom Opportunities analizadas:** 457
...
| 2.0-3.0 ATR (Cerca) | 86 | 80.2% | 83.7% | 4.55 | 72.1% | 2.03 | ✅ BUENA CALIDAD - Considerar incluir |
...
**2.0-3.0 ATR (Cerca)** (86 oportunidades)

- **WR Teórico:** 80.2% (si se hubieran ejecutado)
- **TP_FIRST:** 83.7% (72 de 86)
- **SL_FIRST:** 16.3% (14 de 86)
- **MFE Promedio:** 73.97 pts
- **MAE Promedio:** 35.16 pts
- **MFE/MAE Ratio:** 4.55
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 13 | 162 | 86 | 145 |
| **TP_FIRST %** | 53.8% | 75.3% | 83.7% | 85.5% |
| **Good Entries %** | 46.2% | 77.2% | 72.1% | 82.8% |
| **MFE/MAE Ratio** | 79.74 | 4.17 | 4.55 | 10.83 |

**💡 RECOMENDACIONES BASADAS EN DATOS:**

🚨 **CRÍTICO: El rango 2.0-3.0 ATR contiene 86 oportunidades de BUENA CALIDAD**
   - WR Teórico: 80.2%
   - Good Entries: 72.1%
