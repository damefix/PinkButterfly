...
**Fecha:** 2025-11-11 19:56:14
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251111_195212.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251111_195212.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 39839 | 100.0% | 100.0% |
| ProximityAnalyzer | 6 | 0.0% | 0.0% |
| DFM_Evaluated | 207 | 3450.0% | 0.5% |
| DFM_Passed | 190 | 91.8% | 0.5% |
| RiskCalculator | 54 | 28.4% | 0.1% |
| TradeManager | 37 | 68.5% | 0.1% |

**Análisis:**
- **Mayor caída:** ProximityAnalyzer (pierde 39833 señales, -100.0%)
- **Tasa de conversión final:** 0.09% (de 39839 zonas iniciales → 37 operaciones)

### 3.2 Distribución por Tipo de TP

| Tipo TP | Count | % |
|---------|-------|---|
| P0_SWING_LITE | 414 | 92.8% |
| P0_ANY_DIR | 32 | 7.2% |
...
- **MFE Promedio:** 34.82 pts (máxima ganancia flotante)
- **MAE Promedio:** 42.24 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 1.71
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 37 | 12 | 24 | 32.4% | 34.82 | 42.24 |
...
| T0016 | SELL | 29.00 | 42.25 | 0.69 | SL_FIRST | CLOSED | ⚠️ Entrada dudosa |
| T0017 | BUY | 36.50 | 82.00 | 0.45 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
