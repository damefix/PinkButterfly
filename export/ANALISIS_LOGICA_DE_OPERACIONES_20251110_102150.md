...
**Fecha:** 2025-11-10 10:22:39
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251110_102150.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251110_102150.csv`
...
- **MFE Promedio:** 66.58 pts (máxima ganancia flotante)
- **MAE Promedio:** 7.65 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 402.41

**Dirección Inicial (primeras 3 barras @ 5m):**

| Dirección | Count | % |
|-----------|-------|---|
| TP_FIRST (precio fue hacia TP) | 67 | 90.5% |
| SL_FIRST (precio fue hacia SL) | 6 | 8.1% |
| NEUTRAL (sin dirección clara) | 1 | 1.4% |
...
| PENDING | 72 | 65 | 6 | 90.3% | 66.18 | 7.78 |
...
| T0020 | SELL | 54.50 | 3.25 | 16.77 | TP_FIRST | PENDING | ✅ Entrada excelente |
...
**Rationale:** Basado en percentil 90 de operaciones reales (SL: 77.8pts, TP: 121.9pts)
...
**Problema:** R:R actual (1.60) < R:R mínimo (1.75)
