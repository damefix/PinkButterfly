...
**Fecha:** 2025-11-07 16:13:00  
**CSV File:** `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251107_160827.csv`  
**Trades Analizados:** 0
...
| **Proximity** | 0.2671 | 34.8% |
| **Confluence** | 0.1500 | 19.6% |
| **Type** | 0.0000 | 0.0% |
| **Bias** | 0.1000 | 13.0% |
| **Momentum** | 0.0000 | 0.0% |
| **TOTAL (Avg Confidence)** | 0.7671 | 100% |

### Resumen de Señales

- **Evaluaciones totales:** 1
- **Señales generadas:** 1 (100.0%)
