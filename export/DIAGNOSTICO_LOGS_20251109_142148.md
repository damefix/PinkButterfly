# Informe Diagnóstico de Logs - 2025-11-09 14:22:10

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251109_142148.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251109_142148.csv`
...
- **Priority Seleccionados**: {'P4_Fallback': 189, 'P3': 7}
- **Type Candidatos**: {'Swing': 968}
- **Type Seleccionados**: {'Calculated': 189, 'Swing': 7}
- **TF Candidatos**: {15: 454, 5: 241, 60: 174, 240: 96, 1440: 3}
- **TF Seleccionados**: {-1: 189, 15: 3, 5: 4}
- **DistATR** - Candidatos: avg=6.2 | Seleccionados: avg=7.1
- **RR** - Candidatos: avg=0.99 | Seleccionados: avg=1.01
- **Razones de selección**: {'NoStructuralTarget': 189, 'Intradía(15→5→60→240)': 7}
