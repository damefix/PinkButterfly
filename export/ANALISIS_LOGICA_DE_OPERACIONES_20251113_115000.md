...
**Fecha:** 2025-11-13 11:55:16
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251113_115000.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251113_115000.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 10326 | 100.0% | 100.0% |
| ProximityAnalyzer | 4161 | 40.3% | 40.3% |
| DFM_Evaluated | 844 | 20.3% | 8.2% |
| DFM_Passed | 844 | 100.0% | 8.2% |
| RiskCalculator | 6334 | 750.5% | 61.3% |
| Risk_Accepted | 1 | 0.0% | 0.0% |
| TradeManager | 35 | 3500.0% | 0.3% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6333 señales, -100.0%)
- **Tasa de conversión final:** 0.34% (de 10326 zonas iniciales → 35 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,654 | 58.5% |
| NO_SL | 530 | 18.7% |
| ENTRY_TOO_FAR | 380 | 13.4% |
| TP_CHECK_FAIL | 264 | 9.3% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,654 rechazos, 58.5%)
...
- **MFE Promedio:** 45.80 pts (máxima ganancia flotante)
- **MAE Promedio:** 29.43 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 88.64
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 35 | 24 | 10 | 68.6% | 45.80 | 29.43 |
...
|----------|-----|-----------|-----------|-------|-------------|-----------|-------------|
| T0001 | BUY | 22.75 | 21.00 | 1.08 | SL_FIRST | CLOSED | 👍 Entrada correcta |
| T0004 | BUY | 15.00 | 26.75 | 0.56 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
...
| T0050 | BUY | 11.25 | 10.00 | 1.12 | SL_FIRST | CLOSED | 👍 Entrada correcta |
...
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 481 | 37.4% | 59.3% | 3.95 | 45.5% | 2.02 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 251 | 51.0% | 51.8% | 1.64 | 48.6% | 1.92 | ❌ BAJA CALIDAD - Filtro correcto |
| 3.0-5.0 ATR (Media) | 361 | 68.7% | 57.9% | 2.96 | 60.7% | 2.03 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 200 | 70.0% | 65.5% | 0.81 | 67.5% | 2.38 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 16 | 62.5% | 50.0% | 0.15 | 50.0% | 3.22 | ❌ BAJA CALIDAD - Filtro correcto |

**📈 Análisis Detallado por Rango:**

**0.0-2.0 ATR (Muy cerca)** (481 oportunidades)

- **WR Teórico:** 37.4% (si se hubieran ejecutado)
- **TP_FIRST:** 59.3% (285 de 481)
- **SL_FIRST:** 38.0% (183 de 481)
- **MFE Promedio:** 49.06 pts
- **MAE Promedio:** 39.16 pts
- **MFE/MAE Ratio:** 3.95
...
- **WR Teórico:** 51.0% (si se hubieran ejecutado)
- **TP_FIRST:** 51.8% (130 de 251)
- **SL_FIRST:** 47.4% (119 de 251)
- **MFE Promedio:** 57.25 pts
- **MAE Promedio:** 42.21 pts
- **MFE/MAE Ratio:** 1.64
...
- **TP_FIRST:** 57.9% (209 de 361)
- **SL_FIRST:** 41.6% (150 de 361)
- **MFE Promedio:** 70.93 pts
- **MAE Promedio:** 43.36 pts
- **MFE/MAE Ratio:** 2.96
...
- **TP_FIRST:** 65.5% (131 de 200)
- **SL_FIRST:** 33.5% (67 de 200)
- **MFE Promedio:** 80.96 pts
- **MAE Promedio:** 51.21 pts
- **MFE/MAE Ratio:** 0.81
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 35 | 481 | 251 | 361 |
| **TP_FIRST %** | 68.6% | 59.3% | 51.8% | 57.9% |
| **Good Entries %** | 51.4% | 45.5% | 48.6% | 60.7% |
| **MFE/MAE Ratio** | 88.64 | 3.95 | 1.64 | 2.96 |
...
**Gap:** -0.30 (necesitas mejorar R:R)
...
**Problema:** R:R actual (2.49) < R:R mínimo (2.18)
