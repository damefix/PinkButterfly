# Informe Diagnóstico de Logs - 2025-11-21 18:32:34

- Log: `..\..\NinjaTrader 8\PinkButterfly\logs\backtest_20251121_182340.log`
- CSV: `..\..\NinjaTrader 8\PinkButterfly\logs\trades_20251121_182340.csv`
...
## Proximity
- Eventos: 3127
- KeptAligned: 3865/3865 | KeptCounter: 4416/4713
...
- Eventos: 3127
- Aligned pre: 3865/8281 | Counter pre: 4416/8281
- AvgProxAligned(pre)≈ 0.247 | AvgDistATRAligned(pre)≈ 0.99

### Proximity Drivers
- Eventos: 3127
- Alineadas: n=3865 | BaseProx≈ 0.733 | ZoneATR≈ 4.70 | SizePenalty≈ 0.978 | FinalProx≈ 0.716
- Contra-bias: n=4084 | BaseProx≈ 0.509 | ZoneATR≈ 5.86 | SizePenalty≈ 0.962 | FinalProx≈ 0.490
...
## StructureFusion
- Trazas por zona: 48138 | Zonas con Anchors: 48138
- Dir zonas (zona): Bull=3466 Bear=43579 Neutral=1093
- Resumen por ciclo (promedios): TotHZ≈ 15.4, WithAnchors≈ 15.4, DirBull≈ 1.1, DirBear≈ 13.9, DirNeutral≈ 0.3
- Razones de dirección: {'anchors+triggers': 46527, 'tie-bias': 1611}
- TF Triggers: {'5': 31761, '15': 16377}
- TF Anchors: {'60': 48138, '240': 48138, '1440': 48138}
...
- [TIMING_ADAPT] eventos: 112 | Approach rejects: 125
- Score/Req promedio: 2.39/2.00
- [HTF_CONFL] muestras: 774 | ok=774 | rejects=0
- median≈ 0.125 | thr≈ 0.120
- [BIAS_FAST] muestras: 1295 | Bull=140 Bear=1014 Neutral=141 | rejects=8
- score promedio: -0.51
- [HTF_CONFL] muestras: 774 | ok=774 | rejects=0
- median≈ 0.125 | thr≈ 0.120
...
### Stop Loss (SL)
- Zonas analizadas: 7546 | Total candidatos: 195669 | Seleccionados: 82
- Candidatos por zona (promedio): 25.9

### Take Profit (TP)
- Zonas analizadas: 7546 | Total candidatos: 299493 | Seleccionados: 7546
...
- **Priority Candidatos**: {'P3': 170698}
- **Priority Seleccionados**: {'P3': 6674, 'NA': 657, 'P0': 215}
- **Type Candidatos**: {'Swing': 170698}
- **Type Seleccionados**: {'P3_Swing': 6674, 'P4_Fallback': 657, 'P0_Zone': 215}
- **TF Candidatos**: {5: 81979, 15: 48237, 240: 22295, 60: 18187}
- **TF Seleccionados**: {5: 4500, 240: 1322, 15: 506, 60: 561, -1: 657}
- **DistATR** - Candidatos: avg=34.0 | Seleccionados: avg=14.5
- **RR** - Candidatos: avg=7.85 | Seleccionados: avg=1.34
- **Razones de selección**: {'BestIntelligentScore': 7546}
