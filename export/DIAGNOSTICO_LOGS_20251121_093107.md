# Informe Diagnóstico de Logs - 2025-11-21 09:38:58
...
## Proximity
- Eventos: 3128
- KeptAligned: 3857/3857 | KeptCounter: 4493/4822
- Promedios reportados (media de promedios por evento):
  - AvgProxAligned≈ 0.232 | AvgProxCounter≈ 0.236
  - AvgDistATRAligned≈ 0.88 | AvgDistATRCounter≈ 1.20
- PreferAligned eventos: 931 | Filtradas contra-bias: 198

### Proximity (Pre-PreferAligned)
- Eventos: 3128
- Aligned pre: 3857/8350 | Counter pre: 4493/8350
- AvgProxAligned(pre)≈ 0.232 | AvgDistATRAligned(pre)≈ 0.88
...
## StructureFusion
- Trazas por zona: 49411 | Zonas con Anchors: 49411
- Dir zonas (zona): Bull=3394 Bear=45465 Neutral=552
- Resumen por ciclo (promedios): TotHZ≈ 15.8, WithAnchors≈ 15.8, DirBull≈ 1.1, DirBear≈ 14.5, DirNeutral≈ 0.2
- Razones de dirección: {'anchors+triggers': 48624, 'tie-bias': 787}
- TF Triggers: {'5': 31291, '15': 18120}
- TF Anchors: {'60': 49411, '240': 49411, '1440': 49411}
...
- [TIMING_ADAPT] eventos: 114 | Approach rejects: 80
- Score/Req promedio: 2.42/2.00
- [HTF_CONFL] muestras: 656 | ok=656 | rejects=0
- median≈ 0.111 | thr≈ 0.105
- [BIAS_FAST] muestras: 1112 | Bull=54 Bear=961 Neutral=97 | rejects=6
- score promedio: -0.58
- [HTF_CONFL] muestras: 656 | ok=656 | rejects=0
- median≈ 0.111 | thr≈ 0.105
