...
**Fecha:** 2025-11-09 18:59:29
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251109_185901.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251109_185901.csv`
...
```csharp
// En EngineConfig.cs
public int MaxSLDistancePoints { get; set; } = 98; // Era 60
public int MaxTPDistancePoints { get; set; } = 25; // Era 120
```

**Rationale:** Basado en percentil 90 de operaciones reales (SL: 98.7pts, TP: 25.3pts)
...
**Estado actual:** R:R promedio = 36.19
**Gap:** -34.44 (necesitas mejorar R:R)
...
**Solución:**
1. **MaxSLDistancePoints:** 60 → **98** (P90 real)
2. **MaxTPDistancePoints:** 120 → **25** (P90 real)
...
**Problema:** R:R actual (36.19) < R:R mínimo (1.75)
