...
**Fecha:** 2025-11-13 07:54:48
**LOG:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\backtest_20251113_074936.log`
**CSV:** `C:\Users\meste\Documents\NinjaTrader 8\PinkButterfly\logs\trades_20251113_074936.csv`
...
|------|---------------|---------------|------------|
| StructureFusion | 10297 | 100.0% | 100.0% |
| ProximityAnalyzer | 4156 | 40.4% | 40.4% |
| DFM_Evaluated | 860 | 20.7% | 8.4% |
| DFM_Passed | 860 | 100.0% | 8.4% |
| RiskCalculator | 6301 | 732.7% | 61.2% |
| Risk_Accepted | 106 | 1.7% | 1.0% |
| TradeManager | 36 | 34.0% | 0.3% |

**Análisis:**
- **Mayor caída:** Risk_Accepted (pierde 6195 señales, -98.3%)
- **Tasa de conversión final:** 0.35% (de 10297 zonas iniciales → 36 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 1,650 | 58.9% |
| NO_SL | 509 | 18.2% |
| ENTRY_TOO_FAR | 381 | 13.6% |
| TP_CHECK_FAIL | 261 | 9.3% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (1,650 rechazos, 58.9%)
...
- **MFE Promedio:** 44.15 pts (máxima ganancia flotante)
- **MAE Promedio:** 29.28 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 58.66
...
|--------|-------|----------|----------|------------|---------|---------|
| CLOSED | 36 | 25 | 10 | 69.4% | 44.15 | 29.28 |
...
| T0050 | SELL | 26.75 | 40.75 | 0.66 | TP_FIRST | CLOSED | ❌ Entrada muy mala |
...
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 486 | 38.5% | 59.9% | 3.88 | 45.1% | 2.02 | ❌ BAJA CALIDAD - Filtro correcto |
| 2.0-3.0 ATR (Cerca) | 251 | 49.8% | 52.6% | 1.69 | 48.2% | 1.93 | ❌ BAJA CALIDAD - Filtro correcto |
| 3.0-5.0 ATR (Media) | 360 | 69.2% | 57.2% | 2.91 | 61.1% | 2.07 | ✅ BUENA CALIDAD - Considerar incluir |
| 5.0-10.0 ATR (Lejos) | 206 | 69.9% | 65.5% | 0.89 | 68.0% | 2.37 | ✅ BUENA CALIDAD - Considerar incluir |
| >10.0 ATR (Muy lejos) | 15 | 53.3% | 40.0% | 0.13 | 40.0% | 3.41 | ❌ BAJA CALIDAD - Filtro correcto |

**📈 Análisis Detallado por Rango:**

**0.0-2.0 ATR (Muy cerca)** (486 oportunidades)

- **WR Teórico:** 38.5% (si se hubieran ejecutado)
- **TP_FIRST:** 59.9% (291 de 486)
- **SL_FIRST:** 37.9% (184 de 486)
- **MFE Promedio:** 48.57 pts
- **MAE Promedio:** 38.75 pts
- **MFE/MAE Ratio:** 3.88
...
- **TP_FIRST:** 52.6% (132 de 251)
- **SL_FIRST:** 47.4% (119 de 251)
- **MFE Promedio:** 56.51 pts
- **MAE Promedio:** 42.11 pts
- **MFE/MAE Ratio:** 1.69
...
- **MFE Promedio:** 69.54 pts
- **MAE Promedio:** 42.48 pts
- **MFE/MAE Ratio:** 2.91
...
**5.0-10.0 ATR (Lejos)** (206 oportunidades)

- **WR Teórico:** 69.9% (si se hubieran ejecutado)
- **TP_FIRST:** 65.5% (135 de 206)
- **SL_FIRST:** 34.5% (71 de 206)
- **MFE Promedio:** 79.49 pts
- **MAE Promedio:** 50.89 pts
- **MFE/MAE Ratio:** 0.89
- **Good Entries:** 68.0% (MFE > MAE)
- **R:R Promedio:** 2.37
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 36 | 486 | 251 | 360 |
| **TP_FIRST %** | 69.4% | 59.9% | 52.6% | 57.2% |
| **Good Entries %** | 47.2% | 45.1% | 48.2% | 61.1% |
| **MFE/MAE Ratio** | 58.66 | 3.88 | 1.69 | 2.91 |
...
**Estado actual:** R:R promedio = 2.56
...
**Problema:** R:R actual (2.56) < R:R mínimo (2.27)
