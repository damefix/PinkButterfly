...
|------|---------------|---------------|------------|
| StructureFusion | 48138 | 100.0% | 100.0% |
| ProximityAnalyzer | 3865 | 8.0% | 8.0% |
...
- **Tasa de conversión final:** 0.02% (de 48138 zonas iniciales → 8 operaciones)

### 3.1.1 Razones de Rechazo en RiskCalculator

| Razón | Cantidad | % del Total Rechazado |
|-------|----------|----------------------|
| SL_CHECK_FAIL | 4,229 | 67.5% |
| ENTRY_TOO_FAR | 1,295 | 20.7% |
| TP_CHECK_FAIL | 503 | 8.0% |
| NO_SL | 240 | 3.8% |

**Análisis:**
- **Razón dominante:** SL_CHECK_FAIL (4,229 rechazos, 67.5%)
...
- **MAE Promedio:** 10.22 pts (máxima pérdida flotante)
- **Ratio MFE/MAE:** 378.31
...
| SL_FIRST (precio fue hacia SL) | 2 | 25.0% |
| NEUTRAL (sin dirección clara) | 1 | 12.5% |
...
| T0010 | SELL | 79.00 | 19.75 | 4.00 | TP_FIRST | CLOSED | ✅ Entrada excelente |
| T0011 | SELL | 95.75 | 15.25 | 6.28 | NEUTRAL | CLOSED | ✅ Entrada excelente |
...
|-----------------|-------|------------|------------|---------------|----------------|---------|------------|
| 0.0-2.0 ATR (Muy cerca) | 135 | 45.2% | 55.6% | 8.97 | 79.3% | 2.19 | ✅ BUENA CALIDAD - Considerar incluir |
| 2.0-3.0 ATR (Cerca) | 75 | 36.0% | 34.7% | 2.51 | 64.0% | 2.36 | ✅ BUENA CALIDAD - Considerar incluir |
| 3.0-5.0 ATR (Media) | 120 | 42.5% | 44.2% | 0.95 | 56.7% | 2.34 | ⚠️ CALIDAD MEDIA - Revisar |
...
- **TP_FIRST:** 55.6% (75 de 135)
- **SL_FIRST:** 25.9% (35 de 135)
- **MFE Promedio:** 43.79 pts
- **MAE Promedio:** 17.35 pts
- **MFE/MAE Ratio:** 8.97
...
- **TP_FIRST:** 34.7% (26 de 75)
- **SL_FIRST:** 44.0% (33 de 75)
- **MFE Promedio:** 35.44 pts
- **MAE Promedio:** 19.79 pts
- **MFE/MAE Ratio:** 2.51
...
- **TP_FIRST:** 44.2% (53 de 120)
- **SL_FIRST:** 39.2% (47 de 120)
- **MFE Promedio:** 52.03 pts
- **MAE Promedio:** 25.30 pts
- **MFE/MAE Ratio:** 0.95
...
|---------|-------------------|------------------|------------------|------------------|
| **Count** | 8 | 135 | 75 | 120 |
| **TP_FIRST %** | 62.5% | 55.6% | 34.7% | 44.2% |
| **Good Entries %** | 87.5% | 79.3% | 64.0% | 56.7% |
| **MFE/MAE Ratio** | 378.31 | 8.97 | 2.51 | 0.95 |
