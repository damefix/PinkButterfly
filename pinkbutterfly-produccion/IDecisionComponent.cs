...
namespace NinjaTrader.NinjaScript.Indicators.PinkButterfly
{
    ...
    public interface IDecisionComponent
    {
        ...
        /// <param name="timeframeMinutes">Timeframe de análisis en minutos (ej. 60)</param>
        /// <param name="accountSize">Tamaño de la cuenta para calcular position size</param>
        void Process(DecisionSnapshot snapshot, IBarDataProvider barData, CoreEngine coreEngine, int currentBar, int timeframeMinutes, double accountSize);
    }
}
