...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private PinkButterfly.CoreBrainTestRunner[] cacheCoreBrainTestRunner;
		public PinkButterfly.CoreBrainTestRunner CoreBrainTestRunner()
		{
			return CoreBrainTestRunner(Input);
		}

		public PinkButterfly.CoreBrainTestRunner CoreBrainTestRunner(ISeries<double> input)
		{
			if (cacheCoreBrainTestRunner != null)
				for (int idx = 0; idx < cacheCoreBrainTestRunner.Length; idx++)
					if (cacheCoreBrainTestRunner[idx] != null &&  cacheCoreBrainTestRunner[idx].EqualsInput(input))
						return cacheCoreBrainTestRunner[idx];
			return CacheIndicator<PinkButterfly.CoreBrainTestRunner>(new PinkButterfly.CoreBrainTestRunner(), input, ref cacheCoreBrainTestRunner);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.PinkButterfly.CoreBrainTestRunner CoreBrainTestRunner()
		{
			return indicator.CoreBrainTestRunner(Input);
		}

		public Indicators.PinkButterfly.CoreBrainTestRunner CoreBrainTestRunner(ISeries<double> input )
		{
			return indicator.CoreBrainTestRunner(input);
		}
	}
