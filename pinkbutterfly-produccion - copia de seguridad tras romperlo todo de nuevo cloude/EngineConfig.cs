...
namespace NinjaTrader.NinjaScript.Indicators.PinkButterfly
{
    ...
    public class EngineConfig
    {
        ...
        /// <summary>
        /// Timeframe fijo para generar decisiones de trading (en minutos)
        /// HARDCODED: 15 minutos (optimizado en Serie 5.x con 51 experimentos)
        /// Independiente del TF del gráfico donde se aplique el indicador
        /// </summary>
        public const int DECISION_TIMEFRAME_MINUTES = 15;
