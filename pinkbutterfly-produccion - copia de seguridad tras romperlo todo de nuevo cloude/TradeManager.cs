...
namespace NinjaTrader.NinjaScript.Indicators.PinkButterfly
{
    ...
    public class TradeManager
    {
                                       ...
                                       CoreEngine coreEngine, IBarDataProvider barData)
        {
            ...
            // FIX: currentBar viene del TF más bajo (5m), necesitamos el índice correcto para trade.TFDominante
            int currentBarTradeTF = barData.GetCurrentBarIndex(trade.TFDominante);
            double atr = barData.GetATR(trade.TFDominante, 14, currentBarTradeTF);
